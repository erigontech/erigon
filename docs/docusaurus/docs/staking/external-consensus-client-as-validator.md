...
* [Ethereum](../../easy-nodes/how-to-run-an-ethereum-node/ethereum-with-an-external-cl)
* [Gnosis Chain](../../easy-nodes/how-to-run-a-gnosis-chain-node/gnosis-with-an-external-cl)
