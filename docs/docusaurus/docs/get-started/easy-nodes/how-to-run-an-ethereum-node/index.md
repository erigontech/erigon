...
When you get familiar with running Erigon from CLI you may also consider [staking](../../fundamentals/staking/caplin) and/or run a Ethereum node with an [external Consensus Layer](ethereum-with-an-external-cl).
