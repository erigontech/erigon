    ...
    navbar: {
      ...
      items: [
        ...
        },
        {
          type: 'html',
          position: 'right',
          value: '<a href="https://erigon.tech/blog/" target="_blank" rel="noopener noreferrer" class="navbar-blog-btn">Blog</a>',
        },
        {
          type: 'html',
          position: 'right',
          value: '<a href="https://github.com/erigontech/erigon/releases" target="_blank" rel="noopener noreferrer" class="navbar-release-btn">Release Notes</a>',
        },
        {
          type: 'html',
          position: 'right',
