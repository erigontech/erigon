...
## Running with one or more external Sentry instances
...
Flags:
  ...
  -h, --help                               help for sentry
      ...
      --maxpeers int                       Maximum number of network peers (network disabled if set to 0) (default 64)
      ...
      --p2p.protocol uint                  Version of eth p2p protocol (default [69,70,71])
