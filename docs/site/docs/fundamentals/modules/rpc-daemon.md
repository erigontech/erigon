...
Flags:
  ...
  -h, --help                                        help for rpcdaemon
      ...
      --state.cache string                          Amount of data to store in the version-keyed StateCache (an equally-sized code cache is budgeted on top). Set 0 to fall back to a non-versioned last-block cache (default "128MB")
