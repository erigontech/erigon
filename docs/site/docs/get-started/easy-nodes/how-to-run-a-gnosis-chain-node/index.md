...
When you get familiar with running Erigon from CLI you may also consider [staking](/docs/staking/caplin) and/or run a Gnosis node with an [external Consensus Layer](/docs/get-started/easy-nodes/how-to-run-a-gnosis-chain-node/gnosis-with-an-external-cl).
