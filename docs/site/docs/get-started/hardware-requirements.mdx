...
Use **ext4** or **XFS** on a single NVMe device. Either is a good choice: both are in use by operators running Erigon, and the disk figures below are measured on ext4.
