...
The displayed Full-mode measurements use the previous 262,144-block retention window. The 1,100,000-block default increases disk use as its wider window fills.
