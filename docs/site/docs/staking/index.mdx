...
<Link className="lp-card" to="/staking/embedded-builder-pilot">
  <svg className="lp-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 19V9l8-4 8 4v10"/>
    <path d="M8 19v-6h8v6"/>
  </svg>
  <div className="lp-card-title">Embedded ePBS Builder Pilot</div>
  <div className="lp-card-desc">Run and verify Erigon's experimental Gloas builder, including local private-orderflow simulation.</div>
</Link>
