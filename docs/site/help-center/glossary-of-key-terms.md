...
* **Pruning:** The process of removing older, unnecessary data from the blockchain to save disk space. Erigon offers different prune modes (full, minimal, archive) to suit various needs. See [Prune Modes](/fundamentals/prune-modes).
