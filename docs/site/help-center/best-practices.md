...
| Maintain Sufficient RAM             | Ensure your system has at least the recommended RAM for your chosen network and [prune mode](/fundamentals/pruning-modes). See [Hardware Requirements](/get-started/hardware-requirements). | Insufficient RAM, even with Erigon's memory efficiency, will lead to OOM-kill events (Out-of-Memory).                                                                                   |
