...
<Link className="lp-card" to="/v3.3/staking/caplin">
...
<Link className="lp-card" to="/v3.3/staking/external-consensus-client-as-validator">
  <svg className="lp-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
<Link className="lp-card" to="/v3.3/staking/shutter-network">
