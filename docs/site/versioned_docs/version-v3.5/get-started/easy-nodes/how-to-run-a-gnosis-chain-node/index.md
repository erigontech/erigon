...
1. Confirm your machine meets the necessary [Hardware Requirements](/v3.5/get-started/hardware-requirements) based on your desired pruning mode.
2. **Install Docker**:
...
* Add `--prune.mode=minimal` to run minimal [Pruning Mode](/v3.5/fundamentals/pruning-modes) or `--prune.mode=archive` to run an archive node
...
When you get familiar with running Erigon from CLI you may also consider [staking](/v3.5/staking/caplin) and/or run a Gnosis node with an [external Consensus Layer](/v3.5/get-started/easy-nodes/how-to-run-a-gnosis-chain-node/gnosis-with-an-external-cl).
...
Additional flags can be added to [configure](/v3.5/fundamentals/configuring-erigon/) Erigon with several options.
