...
When you get familiar with running Erigon from CLI you may also consider [staking](/v3.5/staking/caplin) and/or running an Ethereum node with an [external Consensus Layer](/v3.5/get-started/easy-nodes/how-to-run-an-ethereum-node/ethereum-with-an-external-cl).
