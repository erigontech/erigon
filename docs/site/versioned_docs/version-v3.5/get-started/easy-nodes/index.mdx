...
<Link className="lp-card" to="/v3.5/get-started/easy-nodes/how-to-run-an-ethereum-node/">
...
<Link className="lp-card" to="/v3.5/get-started/easy-nodes/how-to-run-a-gnosis-chain-node/">
