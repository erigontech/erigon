...
<Link className="lp-card" to="/v3.5/get-started/">
...
<Link className="lp-card" to="/v3.5/get-started/easy-nodes/">
  <svg className="lp-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
<Link className="lp-card" to="/v3.5/fundamentals/">
  <svg className="lp-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/>
    <path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/>
  </svg>
  <div className="lp-card-title">Fundamentals</div>
  <div className="lp-card-desc">Pruning modes, configuration, Docker, JWT, logging, storage optimization, and day-to-day operations.</div>
</Link>
...
<Link className="lp-card" to="/v3.5/staking/">
  <svg className="lp-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
<Link className="lp-card" to="/v3.5/interacting-with-erigon/">
  <svg className="lp-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
<Link
  className="lp-card"
  to="/v3.5/get-started/why-using-erigon"
