...
<Link className="lp-card" to="/v3.6/get-started/">
...
<Link className="lp-card" to="/v3.6/fundamentals/">
  <svg className="lp-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
<Link className="lp-card" to="/v3.6/staking/">
  <svg className="lp-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
<Link
  className="lp-card"
  to="/v3.6/get-started/why-using-erigon"
