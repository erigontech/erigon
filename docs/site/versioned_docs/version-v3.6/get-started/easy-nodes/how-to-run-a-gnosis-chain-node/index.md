...
When you get familiar with running Erigon from CLI you may also consider [staking](/v3.6/staking/caplin) and/or run a Gnosis node with an [external Consensus Layer](/v3.6/get-started/easy-nodes/how-to-run-a-gnosis-chain-node/gnosis-with-an-external-cl).
