...
:::warning
Erigon does not support Polygon — see [Supported Networks](/v3.6/fundamentals/supported-networks). These services are still built in this release, but they are unmaintained and untested.
:::
