...
32-byte hash value, as shown in the function `PubkeyToAddress` in the file [crypto/crypto.go](../../erigon/common/crypto/crypto.go)
...
file [crypto/crypto.go](../../erigon/common/crypto/crypto.go)
