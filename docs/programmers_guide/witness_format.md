...
Each operator starts with an opcode (see [`witness_operators.go`](../../erigon-lib/trie/witness_operators.go) for exact
values).
...
`witness_operators_test.go`](../../erigon-lib/trie/witness_operators_test.go) to see flags in action).
