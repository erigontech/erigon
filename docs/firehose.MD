...
- Single block hash per request as opposed to multiple state roots per request in GetStateRanges
...
The requester asks for state data (i.e. accounts) defined by a key prefix as of a given block.
