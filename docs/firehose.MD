...
- Dropped "fuzzy" flag
- Renamed GetStateNodeData -> GetStateNodes, GetStorageNodeData -> GetStorageNodes
...
- StateData & StorageData may only have all subtrie leaves or nothing, not intermediate nodes
