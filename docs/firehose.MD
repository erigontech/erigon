...
Note that this operative is similar to `GetNodeData` of ETH/63, but uses prefixes rather than hashes as node keys.
...
In that case available blocks should be populated.
