...
You can use **Prysm**, **Lighthouse**, or any other Consensus Layer client with Erigon by including the `--externalcl`
flag. This integration enables direct access to the Ethereum blockchain, allowing you to manage your keys for staking
ETH and block production.
...
4. Prysm must point to the [JWT secret](../../../fundamentals/jwt.md) automatically created by Erigon in the `--datadir`
   directory.
...
5. Lighthouse must point to the [JWT secret](../../../fundamentals/jwt.md) automatically created by Erigon in the
   `--datadir` directory.
