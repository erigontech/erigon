...
When you get familiar with running Erigon from CLI you may also consider [staking](../../../staking/caplin.md) and/or run a Ethereum node with an [external Consensus Layer](ethereum-with-an-external-cl.md).
