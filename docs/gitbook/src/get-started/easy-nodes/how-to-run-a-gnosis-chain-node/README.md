...
When you get familiar with running Erigon from CLI you may also consider [staking](../../../staking/caplin.md) and/or run a Gnosis node with an [external Consensus Layer](gnosis-with-an-external-cl.md).
