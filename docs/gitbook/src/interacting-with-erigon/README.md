...
The Erigon RPC Service, managed by Erigon's modular [RPC daemon](../fundamentals/modules/rpc-daemon.md), supports
various API namespaces, which can be enabled or disabled using the `--http.api` flag. The available namespaces include:
