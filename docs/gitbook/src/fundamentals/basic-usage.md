...
{% hint style="warning" %}
**Note**: When you first start Erigon, Windows Firewall may prompt you to allow internet access. Select "YES" to
proceed.
{% endhint %}
{% endtab %}
{% endtabs %}
...
* `--http.addr="0.0.0.0" --http.api=eth,web3,net,debug,trace,txpool` to use [RPC Service](../interacting-with-erigon/)
  and e.g. be able to connect your [wallet](web3-wallet.md).
