...
/*
#cgo !windows !darwin CFLAGS: -O2 -g -DMDBX_BUILD_FLAGS='' -Wall -Werror -Wextra -Wpedantic -Wno-deprecated-declarations -fPIC -fvisibility=hidden -pthread -Wno-error=attributes -W -Wall -Wno-format -Wno-implicit-fallthrough -Wno-unused-parameter -Wno-format-extra-args -Wno-missing-field-initializers
#cgo darwin CFLAGS: -O2 -g -DMDBX_BUILD_FLAGS='' -Wall -Werror -Wextra -Wpedantic -Wno-deprecated-declarations -fPIC -fvisibility=hidden -pthread -Wno-error=attributes -W -Wall -Wno-format -Wno-implicit-fallthrough -Wno-unused-parameter -Wno-format-extra-args -Wno-missing-field-initializers
