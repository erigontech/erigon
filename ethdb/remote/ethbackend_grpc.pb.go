...
type ETHBACKENDClient interface {
	...
	SyncingProgress(ctx context.Context, in *SyncingProgressRequest, opts ...grpc.CallOption) (*SyncingProgressReply, error)
}
...
func (c *eTHBACKENDClient) SyncingProgress(ctx context.Context, in *SyncingProgressRequest, opts ...grpc.CallOption) (*SyncingProgressReply, error) {
	out := new(SyncingProgressReply)
	err := c.cc.Invoke(ctx, "/remote.ETHBACKEND/SyncProgress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ETHBACKENDServer interface {
	...
	SyncingProgress(context.Context, *SyncingProgressRequest) (*SyncingProgressReply, error)
...
func (*UnimplementedETHBACKENDServer) SyncingProgress(context.Context, *SyncingProgressRequest) (*SyncingProgressReply, error) {
...
func _ETHBACKEND_SyncingProgress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SyncingProgressRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ETHBACKENDServer).SyncingProgress(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/remote.ETHBACKEND/SyncProgress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ETHBACKENDServer).SyncingProgress(ctx, req.(*SyncingProgressRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ETHBACKEND_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ETHBACKEND_SyncingProgress_Handler,
		},
	},
