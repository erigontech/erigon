...
type txPool interface {
	...
	PeekBest(ctx context.Context, n int, onTopOf, availableGas, availableBlobGas uint64) (TxnsRlp, error)
...
func (s *GrpcServer) Pending(ctx context.Context, _ *emptypb.Empty) (*txpool_proto.PendingReply, error) {
	...
	txnsRlp, err := s.txPool.PeekBest(ctx, math.MaxInt16 /* amount */, 0 /* onTopOf */, math.MaxUint64 /* availableGas */, math.MaxUint64 /* availableBlobGas */)
	if err != nil {
		return nil, err
	}
