...
In code can find production of such event by `p.newPendingTxns <-`, and handling of this event by `announcements := <-newTxns` here https://github.com/erigontech/erigon/blob/main/txpool/pool.go#L1429
