...
//go:generate solc --base-path . --include-path ./../../../../contracts --abi --bin --overwrite --optimize -o build Sequencer.sol KeyperSet.sol KeyperSetManager.sol KeyBroadcastContract.sol ValidatorRegistry.sol
