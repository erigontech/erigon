...
var (
	chiadoConfig = Config{
		...
		ReorgDepthAwareness:              defaultReorgDepthAwarenessMultiplier * clparams.BeaconConfigs[clparams.ChiadoNetwork].SlotsPerEpoch,
		P2pConfig: P2pConfig{
	...
	gnosisConfig = Config{
		...
		MaxNumKeysPerMessage:             defaultMaxNumKeysPerMessage,
		ReorgDepthAwareness:              defaultReorgDepthAwarenessMultiplier * clparams.BeaconConfigs[clparams.GnosisNetwork].SlotsPerEpoch,
		P2pConfig: P2pConfig{
			ListenPort: defaultP2PListenPort,
			BootstrapNodes: []string{
...
const (
	...
	defaultReorgDepthAwarenessMultiplier = 3 // number of epochs
)
