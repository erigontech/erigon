...
func (tx *ArbitrumUnsignedTx) Sender(signer types.Signer) (accounts.Address, error) {
...
func (tx *ArbitrumContractTx) Sender(signer types.Signer) (accounts.Address, error) {
	return accounts.InternAddress(tx.From), nil
}
...
func (tx *ArbitrumRetryTx) Sender(signer types.Signer) (accounts.Address, error) {
	return accounts.InternAddress(tx.From), nil
}

func (tx *ArbitrumRetryTx) CachedSender() (accounts.Address, bool) {
	return accounts.InternAddress(tx.From), true
}

func (tx *ArbitrumRetryTx) GetSender() (accounts.Address, bool) {
	return accounts.InternAddress(tx.From), true
}

func (tx *ArbitrumRetryTx) SetSender(address accounts.Address) {
	tx.From = address.Value()
}
...
func (tx *ArbitrumSubmitRetryableTx) copy() *ArbitrumSubmitRetryableTx {
	cpy := &ArbitrumSubmitRetryableTx{
		...
		RetryData:        bytes.Clone(tx.RetryData),
...
func (tx *ArbitrumSubmitRetryableTx) Sender(signer types.Signer) (accounts.Address, error) {
	return accounts.InternAddress(tx.From), nil
}
...
func (tx *ArbitrumInternalTx) Sender(signer types.Signer) (accounts.Address, error) {
...
func (tx *ArbitrumInternalTx) SetSender(address accounts.Address) {}
