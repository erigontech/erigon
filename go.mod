...
require (
	...
	github.com/ledgerwatch/erigon-snapshot v1.3.1-0.20240520021853-7506b1c6ef70 // indirect
...
replace (
	github.com/anacrolix/torrent => github.com/erigontech/torrent v1.54.2-alpha-11
