...
require (
	github.com/ledgerwatch/erigon-lib v0.0.0-20230126034024-fd7c9ab148df
...
replace github.com/ledgerwatch/erigon-lib => github.com/roberto-bayardo/erigon-lib v0.0.0-20230126115636-2090fc9ee30b
