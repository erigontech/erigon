...
require (
	github.com/ledgerwatch/erigon-lib v0.0.0-20221229061926-c047e0a31a75
...
replace github.com/ledgerwatch/erigon-lib => github.com/roberto-bayardo/erigon-lib v0.0.0-20221229161106-35ac4a79c7e4
