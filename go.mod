...
require (
	github.com/erigontech/mdbx-go v0.39.0-alpha.0.20240609125008-409bb2c572bc
...
require (
	...
	github.com/ledgerwatch/erigon-snapshot v1.3.1-0.20240610035052-3dc3004df7a0 // indirect
