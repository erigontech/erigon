...
require (
	...
	github.com/ledgerwatch/erigon-snapshot v1.3.1-0.20240614130019-fe930df7be33 // indirect
...
replace (
	github.com/anacrolix/torrent => github.com/erigontech/torrent v1.54.2-alpha-16
