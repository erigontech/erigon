...
require (
	...
	github.com/ledgerwatch/erigon-lib v0.0.0-20230210171712-4e6a22717c6d // indirect
	github.com/ledgerwatch/interfaces v0.0.0-20230201210041-46fc5eaf2814 // indirect
