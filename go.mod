...
require (
	github.com/erigontech/mdbx-go v0.39.0-alpha.0.20240621022551-9fc3dad107d4
...
require (
	...
	github.com/ledgerwatch/erigon-snapshot v1.3.1-0.20240619063107-2c189597a8e0 // indirect
