...
require (
	github.com/ledgerwatch/erigon-lib v0.0.0-20230322081954-d9dc1fc2b51b
...
replace github.com/ledgerwatch/erigon-lib => github.com/chainstack/erigon-lib v0.0.0-20230330095146-244f7bd553e0
