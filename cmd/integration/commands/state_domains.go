...
func (b *blockProcessor) applyBlock(
	...
	for i, tx := range block.Transactions() {
		if b.txNum >= b.startTxNum {
			...
			receipt, _, err := core.ApplyTransaction(b.chainConfig, getHashFn, b.engine, nil, gp, ibs, b.writer, header, tx, usedGas, dataGasUsed, b.vmConfig, parentHeader.ExcessDataGas)
			if err != nil {
