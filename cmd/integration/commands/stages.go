...
var cmdRunMigrations = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		logger := debug.SetupCobra(cmd, "integration")
		migrations.EnableSqueezeCommitmentFiles = squeezeCommitment
		migrations.EnableRecompressCommitmentFiles = squeezeStorage
		migrations.EnableCodeRecompress = squeezeCode
