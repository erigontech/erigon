	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		for _, file := range files {
			...
			logger.Info("TOTALS",
				...
				// "%opt-keys", 100*float64(totalBytesK)/float64(totalBytesK+totalOptBytesV),
				// "%opt-values", 100*float64(totalOptBytesV)/float64(totalBytesK+totalOptBytesV),
				// "%opt-keys2", 100*float64(totalBytesK)/float64(totalBytesK+totalOptBytesV2),
				// "%opt-values2", 100*float64(totalOptBytesV2)/float64(totalBytesK+totalOptBytesV2),
				// "%opt-keys3", 100*float64(totalBytesK)/float64(totalBytesK+totalOptBytesV3),
				// "%opt-values3", 100*float64(totalOptBytesV3)/float64(totalBytesK+totalOptBytesV3),
				// "%opt-keys4", 100*float64(totalBytesK)/float64(totalBytesK+totalOptBytesV4),
				// "%opt-values4", 100*float64(totalOptBytesV4)/float64(totalBytesK+totalOptBytesV4),
			)
