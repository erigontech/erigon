...
func init() {
	...
	rootCmd.PersistentFlags().Uint64Var(&priceLimit, "txpool.gaslimit", txpool.DefaultConfig.MinFeeCap, "Minimum gas price (fee cap) limit to enforce for acceptance into the pool")
}
