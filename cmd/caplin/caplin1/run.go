...
func RunCaplinPhase1(ctx context.Context, engine execution_client.ExecutionEngine, config *ethconfig.Config, networkConfig *clparams.NetworkConfig,
	...
	snDownloader proto_downloader.DownloaderClient, backfilling bool, states bool, indexDB kv.RwDB, creds credentials.TransportCredentials, snBuildSema *semaphore.Weighted) error {
	...
	antiq := antiquary.NewAntiquary(ctx, genesisState, vTables, beaconConfig, dirs, snDownloader, indexDB, csn, rcsn, logger, states, backfilling, af, snBuildSema)
