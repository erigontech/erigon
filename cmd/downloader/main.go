...
var createTorrent = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		dirs := datadir.New(datadirCli)
		err := downloader.BuildTorrentFilesIfNeed(cmd.Context(), dirs, downloader.NewAtomicTorrentFiles(dirs.Snap, []string{}), chain, nil)
		if err != nil {
			return err
		}
		return nil
...
func doPrintTorrentHashes(ctx context.Context, logger log.Logger) error {
	...
	tf := downloader.NewAtomicTorrentFiles(dirs.Snap, []string{})
