...
func DefaultTorrentConfig() *torrent.ClientConfig {
	...
	torrentConfig.UploadRateLimiter = rate.NewLimiter(32*1024*1024, DefaultPieceSize)   // default: unlimited
	torrentConfig.DownloadRateLimiter = rate.NewLimiter(32*1024*1024, DefaultPieceSize) // default: unlimited
