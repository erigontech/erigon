...
type ApiBackend interface {
	...
	EngineNewPayloadV1(ctx context.Context, payload *types2.ExecutionPayload) (*remote.EngineNewPayloadReply, error)
...
func (back *RemoteBackend) EngineNewPayloadV1(ctx context.Context, payload *types2.ExecutionPayload) (res *remote.EngineNewPayloadReply, err error) {
