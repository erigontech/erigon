...
func (e *remoteConsensusEngine) Author(header *types.Header) (accounts.Address, error) {
...
func (e *remoteConsensusEngine) IsServiceTransaction(sender accounts.Address, syscall consensus.SystemCall) bool {
	if err := e.validateEngineReady(); err != nil {
		panic(err)
	}
