...
func EmbeddedServices(ctx context.Context, erigonDB kv.RoDB, stateCacheCfg kvcache.CoherentConfig, blockReader services.BlockTxnAndHeaderReader, ethBackendServer remote.ETHBACKENDServer,
...
func RemoteServices(ctx context.Context, cfg httpcfg.HttpCfg, logger log.Logger, rootCancel context.CancelFunc) (
	...
	stateCache kvcache.Cache, blockReader services.BlockTxnAndHeaderReader,
