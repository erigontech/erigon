...
type ComplexityRoot struct {
	...
	Block struct {
		...
		Miner             func(childComplexity int, block *string) int
	...
	Log struct {
		Account     func(childComplexity int, block *string) int
		Data        func(childComplexity int) int
	...
	Query struct {
		...
		Blocks               func(childComplexity int, from *string, to *string) int
	...
	Transaction struct {
		...
		CreatedContract      func(childComplexity int, block *string) int
		...
		From                 func(childComplexity int, block *string) int
		...
		Status               func(childComplexity int) int
		To                   func(childComplexity int, block *string) int
...
type QueryResolver interface {
	...
	Blocks(ctx context.Context, from *string, to *string) ([]*model.Block, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Block.miner":
		...
		return e.complexity.Block.Miner(childComplexity, args["block"].(*string)), true
	...
	case "Log.account":
		...
		return e.complexity.Log.Account(childComplexity, args["block"].(*string)), true
	...
	case "Query.blocks":
		...
		return e.complexity.Query.Blocks(childComplexity, args["from"].(*string), args["to"].(*string)), true
	...
	case "Transaction.createdContract":
		...
		return e.complexity.Transaction.CreatedContract(childComplexity, args["block"].(*string)), true
	...
	case "Transaction.from":
		...
		return e.complexity.Transaction.From(childComplexity, args["block"].(*string)), true
	...
	case "Transaction.to":
		...
		return e.complexity.Transaction.To(childComplexity, args["block"].(*string)), true
...
func (ec *executionContext) field_Block_miner_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["block"]; ok {
		...
		arg0, err = ec.unmarshalOLong2ᚖstring(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Query_blocks_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["to"]; ok {
		...
		arg1, err = ec.unmarshalOLong2ᚖstring(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_blocks(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Blocks(rctx, fc.Args["from"].(*string), fc.Args["to"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
	}
...
func (ec *executionContext) _Transaction_status(ctx context.Context, field graphql.CollectedField, obj *model.Transaction) (ret graphql.Marshaler) {
	...
	res := resTmp.(*string)
	fc.Result = res
	return ec.marshalOLong2ᚖstring(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputCallData(ctx context.Context, obj interface{}) (model.CallData, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "gas":
			...
			it.Gas, err = ec.unmarshalOLong2ᚖstring(ctx, v)
			if err != nil {
				return it, err
			}
		case "gasPrice":
...
func (ec *executionContext) unmarshalInputFilterCriteria(ctx context.Context, obj interface{}) (model.FilterCriteria, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "fromBlock":
			...
			it.FromBlock, err = ec.unmarshalOLong2ᚖstring(ctx, v)
			if err != nil {
				return it, err
			}
		case "toBlock":
			...
			it.ToBlock, err = ec.unmarshalOLong2ᚖstring(ctx, v)
			if err != nil {
				return it, err
			}
		case "addresses":
