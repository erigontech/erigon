...
func TestCallMany(t *testing.T) {
	...
	api := NewEthAPI(NewBaseApi(nil, stateCache, contractBackend.BlockReader(), contractBackend.Agg(), false, rpccfg.DefaultEvmCallTimeout, engine, nil), db, nil, nil, nil, 5000000, 100_000)
