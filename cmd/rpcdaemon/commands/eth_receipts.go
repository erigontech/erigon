...
func (api *APIImpl) GetLogs(ctx context.Context, crit filters.FilterCriteria) ([]*types.Log, error) {
	...
	if crit.BlockHash != nil {
		...
		if crit.FromBlock != nil {
			...
			} else if !crit.FromBlock.IsInt64() || crit.FromBlock.Int64() != int64(rpc.PendingBlockNumber) {
		...
		if crit.ToBlock != nil {
			...
			} else if !crit.ToBlock.IsInt64() || crit.ToBlock.Int64() != int64(rpc.PendingBlockNumber) {
