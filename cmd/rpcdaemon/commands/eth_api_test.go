...
func TestGetBalanceChangesInBlock(t *testing.T) {
	...
	api := NewErigonAPI(NewBaseApi(nil, stateCache, br, agg, false, rpccfg.DefaultEvmCallTimeout, m.Engine, nil), db, nil)
...
func TestGetTransactionReceipt(t *testing.T) {
	...
	br := snapshotsync.NewBlockReaderWithSnapshots(m.BlockSnapshots)
	stateCache := kvcache.New(kvcache.DefaultCoherentConfig)
	api := NewEthAPI(NewBaseApi(nil, stateCache, br, agg, false, rpccfg.DefaultEvmCallTimeout, m.Engine, nil), db, nil, nil, nil, 5000000, 100_000)
