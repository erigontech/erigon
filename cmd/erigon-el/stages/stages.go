...
func NewStagedSync(ctx context.Context,
	...
	return stagedsync.New(
		ExecutionStages(ctx, cfg.Prune,
			...
			stagedsync.StageHistoryCfg(db, cfg.Prune, dirs.Tmp, nil),
			stagedsync.StageLogIndexCfg(db, cfg.Prune, dirs.Tmp, nil),
			stagedsync.StageCallTracesCfg(db, cfg.Prune, 0, dirs.Tmp, nil),
