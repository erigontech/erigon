...
func NewStagedSync(ctx context.Context,
	...
	dirs := cfg.Dirs
	blockRetire := snapshotsync.NewBlockRetire(1, dirs.Tmp, blockReader.Snapshots(), db, snapDownloader, notifications.Events, logger)
	...
	return stagedsync.New(
		ExecutionStages(ctx, cfg.Prune,
			stagedsync.StageSnapshotsCfg(db, *controlServer.ChainConfig, dirs, blockRetire, snapDownloader, blockReader, notifications.Events, engine, cfg.HistoryV3, agg),
