...
var (
	...
	PersistReceiptsV2Flag = cli.BoolFlag{
		...
		Usage: "To store receipts in chaindata db (only on chain-tip) - RPC for recent receipt/logs will be faster. Values: 1_000 good starting point. 10_000 receipts it's ~1Gb (not much IO increase). Please test before go over 100_000",
