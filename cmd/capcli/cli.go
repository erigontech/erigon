...
func (c *DumpSnapshots) Run(ctx *Context) error {
	...
	return freezeblocks.DumpBeaconBlocks(ctx, db, beaconDB, c.SnapshotVersion, 0, to, snaptype.Erigon2RecentMergeLimit, dirs.Tmp, dirs.Snap, 8, log.LvlInfo, log.Root())
}
