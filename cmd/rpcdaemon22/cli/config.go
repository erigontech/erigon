...
func EmbeddedServices(ctx context.Context, erigonDB kv.RoDB, stateCacheCfg kvcache.CoherentConfig, blockReader services.FullBlockReader, snapsthots remotedbserver.Snapsthots, ethBackendServer remote.ETHBACKENDServer,
	...
	kvRPC := remotedbserver.NewKvServer(ctx, erigonDB, snapsthots)
