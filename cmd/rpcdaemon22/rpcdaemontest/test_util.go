...
import (
	...
	"github.com/ledgerwatch/erigon/cmd/rpcdaemon22/commands/contracts"
...
func CreateTestGrpcConn(t *testing.T, m *stages.MockSentry) (context.Context, *grpc.ClientConn) { //nolint
	...
	remote.RegisterETHBACKENDServer(server, privateapi.NewEthBackendServer(ctx, nil, m.DB, m.Notifications.Events, snapsync.NewBlockReader(), nil, nil, nil, nil, false))
