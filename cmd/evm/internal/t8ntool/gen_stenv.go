...
func (s stEnv) MarshalJSON() ([]byte, error) {
	...
	enc.BlockAccessListHash = s.BlockAccessListHash
	enc.BlockAccessList = s.BlockAccessList
...
func (s *stEnv) UnmarshalJSON(input []byte) error {
	...
	if dec.BlockAccessListHash != nil {
		s.BlockAccessListHash = dec.BlockAccessListHash
	}
	if dec.BlockAccessList != nil {
		s.BlockAccessList = dec.BlockAccessList
	}
	return nil
}
