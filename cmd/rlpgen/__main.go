...
// sort of recursion
func generate(b1, b2, b3 *bytes.Buffer, typ *types.Named, g *scope) error {
...
func handleType(t types.Type, caller types.Type, depth int, ptr bool, g *scope) {
...
// func addEncodeLogic(b1, b2, b3 *bytes.Buffer, g *scope) error {
