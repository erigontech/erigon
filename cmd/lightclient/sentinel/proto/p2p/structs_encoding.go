...
// Hash: 9d4de48afd722dc6d5530d7d10f539cfb625710804ac9657273e85684664622e
// Version: 0.1.2
package p2p
...
// Clone creates a new instance of a SingleRoot object
func (s *SingleRoot) Clone() proto.Packet {
	return &SingleRoot{}
}
...
// Clone creates a new instance of a LightClientBootstrap object
func (l *LightClientBootstrap) Clone() proto.Packet {
...
// Clone creates a new instance of a LightClientUpdatesByRangeRequest object
func (l *LightClientUpdatesByRangeRequest) Clone() proto.Packet {
...
// Clone creates a new instance of a LightClientUpdatesByRangeResponse object
func (l *LightClientUpdatesByRangeResponse) Clone() proto.Packet {
	return &LightClientUpdatesByRangeResponse{}
}

// MarshalSSZ ssz marshals the LightClientUpdatesByRangeResponse object
func (l *LightClientUpdatesByRangeResponse) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(l)
}

// MarshalSSZTo ssz marshals the LightClientUpdatesByRangeResponse object to a target array
func (l *LightClientUpdatesByRangeResponse) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(4)

	// Offset (0) 'Updates'
	dst = ssz.WriteOffset(dst, offset)
	for ii := 0; ii < len(l.Updates); ii++ {
		offset += 4
		offset += l.Updates[ii].SizeSSZ()
	}

	// Field (0) 'Updates'
	if size := len(l.Updates); size > 128 {
		err = ssz.ErrListTooBigFn("LightClientUpdatesByRangeResponse.Updates", size, 128)
		return
	}
	{
		offset = 4 * len(l.Updates)
		for ii := 0; ii < len(l.Updates); ii++ {
			dst = ssz.WriteOffset(dst, offset)
			offset += l.Updates[ii].SizeSSZ()
		}
	...
	for ii := 0; ii < len(l.Updates); ii++ {
		if dst, err = l.Updates[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}
...
// UnmarshalSSZ ssz unmarshals the LightClientUpdatesByRangeResponse object
func (l *LightClientUpdatesByRangeResponse) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 4 {
		return ssz.ErrSize
	...
	// Field (0) 'Updates'
	{
		...
		l.Updates = make([]*LightClientUpdate, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if err = l.Updates[indx].UnmarshalSSZ(buf); err != nil {
				return err
			}
			return nil
		})
...
// SizeSSZ returns the ssz encoded size in bytes for the LightClientUpdatesByRangeResponse object
func (l *LightClientUpdatesByRangeResponse) SizeSSZ() (size int) {
	size = 4

	// Field (0) 'Updates'
	for ii := 0; ii < len(l.Updates); ii++ {
		size += 4
		size += l.Updates[ii].SizeSSZ()
	}

	return
}

// HashTreeRoot ssz hashes the LightClientUpdatesByRangeResponse object
func (l *LightClientUpdatesByRangeResponse) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(l)
}

// HashTreeRootWith ssz hashes the LightClientUpdatesByRangeResponse object with a hasher
func (l *LightClientUpdatesByRangeResponse) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()

	// Field (0) 'Updates'
	{
		subIndx := hh.Index()
		num := uint64(len(l.Updates))
		if num > 128 {
			err = ssz.ErrIncorrectListSize
			return
		}
		for _, elem := range l.Updates {
...
// GetTree ssz hashes the LightClientUpdatesByRangeResponse object
func (l *LightClientUpdatesByRangeResponse) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(l)
}

// Clone creates a new instance of a LightClientUpdate object
func (l *LightClientUpdate) Clone() proto.Packet {
...
// Clone creates a new instance of a LightClientFinalityUpdate object
func (l *LightClientFinalityUpdate) Clone() proto.Packet {
...
// Clone creates a new instance of a LightClientOptimisticUpdate object
func (l *LightClientOptimisticUpdate) Clone() proto.Packet {
