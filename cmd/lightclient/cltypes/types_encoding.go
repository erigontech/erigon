...
// Hash: 4429080c41f8dc925e32389fca6a8d4b782425eab4cc51c3538e582d833beedf
// Version: 0.1.2
package cltypes
...
func (p *PendingAttestation) UnmarshalSSZ(buf []byte) error {
	...
	if err = p.Data.UnmarshalSSZ(buf[4:52]); err != nil {
		return err
	}

	// Field (2) 'InclusionDelay'
	p.InclusionDelay = ssz.UnmarshallUint64(buf[52:60])

	// Field (3) 'ProposerIndex'
	p.ProposerIndex = ssz.UnmarshallUint64(buf[60:68])
