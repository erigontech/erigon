	...
	tests := []struct {
		...
		},
		{
			...
			[]testcase{
				...
				{39834365, 1746021820, ID{Hash: ChecksumToBytes(0x2f095d4a), Activation: 1746021820, Next: 1767540000}}, // First Prague block (approx)
				{50000000, 1800000000, ID{Hash: ChecksumToBytes(0xa17c3f0f), Activation: 1767540000, Next: 0}},          // Future Balancer block (mock)
			},
		},
		{
			chainspec.Chiado,
