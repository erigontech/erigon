...
func testForkIDSplit(t *testing.T, protocol uint) {
	var (
		ctx           = context.Background()
		configNoFork  = &chain.Config{HomesteadBlock: chain.NewUint64(1), ChainID: big.NewInt(1)}
		configProFork = &chain.Config{
			ChainID:               big.NewInt(1),
			HomesteadBlock:        chain.NewUint64(1),
			TangerineWhistleBlock: chain.NewUint64(2),
			SpuriousDragonBlock:   chain.NewUint64(2),
			ByzantiumBlock:        chain.NewUint64(3),
		}
