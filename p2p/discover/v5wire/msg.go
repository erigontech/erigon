...
type (
	...
	Whoareyou struct {
		...
		// ChallengeData contains the full packet encoding before masking.
		// This data is later used during identity verification and is
		// populated during both Encode and Decode steps.
