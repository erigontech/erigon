...
// 8.0 - LargeValues domains (Code, RCache, Commitment) store values in a seqID-indexed table: keys table (DupSort) maps bareKey -> invStep+seqID, vals table maps seqID -> value
