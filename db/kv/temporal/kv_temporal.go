...
// state-file view substitutes the given .kv files for their live counterparts.
// Used to validate staged (not-yet-live) snapshot files in the context of the
// live state. The substitute files are released on Rollback.
...
// temporalFilesPin implements kv.TemporalFilesPin: holds a consistent
...
// read txns opened from it stay on that generation.
