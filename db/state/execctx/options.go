...
// and its adaptive pin controller. Callers that require commitment reads to stay
// within a transaction snapshot must use it because cache entries are not view-bound.
