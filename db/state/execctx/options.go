...
// WithoutSharedBranchCache disables BranchCache use and the monotonic
// visibility guard it requires. Use it when tooling intentionally lowers or
// rebuilds the commitment-file frontier.
