...
func TestEmbeddedRPCCacheViewDoesNotRefillUnwoundAccount(t *testing.T) {
	...
	unwindDomains.SetCanonicalCachesForTest(stateCache)
	...
	freshDomains.SetCanonicalCachesForTest(stateCache)
...
func TestSharedDomainsSameDatabaseViewUsesReadTxFilesGeneration(t *testing.T) {
	...
	require.NoError(t, err)
	oldDomains.SetCanonicalCachesForTest(stateCache)
	oldDomains.Close()
...
func TestAccountOnlyDeleteDoesNotBlockUnrelatedCodeFill(t *testing.T) {
	...
	deleteDomains.SetCanonicalCachesForTest(stateCache)
...
func TestCanonicalUnwindClearsNegativeCacheEntry(t *testing.T) {
	...
	require.NoError(t, err)
	readDomains.SetCanonicalCachesForTest(stateCache)
