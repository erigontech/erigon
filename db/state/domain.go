...
func (d *Domain) dumpStepRangeOnDisk(ctx context.Context, stepFrom, stepTo kv.Step, batch kv.TemporalMemBatch, vt valueTransformer) error {
	if d.Disable || stepFrom == stepTo {
		return nil
	}
	wal := batch.(*TemporalMemBatch).domainWriters[d.Name]
