...
func TestWriteRawTransactions(t *testing.T) {
	...
	err := rawdb.WriteRawTransactions(tx, rawTxs, baseTxnID)
...
func TestWriteRawTransactions_EmptySlice(t *testing.T) {
	...
	err := rawdb.WriteRawTransactions(tx, [][]byte{}, types.BaseTxnID(100))
	require.NoError(t, err)
...
func TestWriteTransactions(t *testing.T) {
	...
	err := rawdb.WriteTransactions(tx, txs, baseTxnID)
	require.NoError(t, err)
...
func TestWriteTransactions_WrapperBehavior(t *testing.T) {
	...
	{
		err := rawdb.WriteTransactions(tx1, txs, baseTxnID)
		require.NoError(t, err)
	}
	...
	err = rawdb.WriteRawTransactions(tx2, rawTxs, baseTxnID)
	require.NoError(t, err)
