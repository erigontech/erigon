...
func TestParseFileNameHash(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "V2 torrent wrapper without hash",
			fileName: "v1.0-000000-001000-headers.seg.torrent",
			wantHash: "",
			wantFrom: 0,
			wantTo:   1_000_000,
			wantType: "headers",
		...
		{
			name:     "V2 torrent wrapper with hash",
			fileName: "v1.0-000000-001000-headers.abc123def0.seg.torrent",
			wantHash: "abc123def0",
			wantFrom: 0,
			wantTo:   1_000_000,
			wantType: "headers",
		...
		{
			name:     "V2 idx torrent wrapper without hash",
			fileName: "v1.0-000000-001000-headers.idx.torrent",
			wantHash: "",
			wantFrom: 0,
			wantTo:   1_000_000,
			wantType: "headers",
		...
		{
			name:     "V2 idx torrent wrapper with hash",
			fileName: "v1.0-000000-001000-headers.abc123def0.idx.torrent",
			wantHash: "abc123def0",
			wantFrom: 0,
			wantTo:   1_000_000,
			wantType: "headers",
