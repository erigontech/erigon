...
func (c blockFinalityContextStub) ReadyForCollation(_ context.Context, _ kv.TemporalRoDB, _ uint64) (finalisedBlockNum, lastBlockInStep, lastBlockInDB, lastTxInDB uint64, ok bool, err error) {
