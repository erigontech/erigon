...
// Lifecycle encompasses the behavior of dbservices that can be started and stopped
...
type Lifecycle interface {
	// Start is called after all dbservices have been constructed and the networking
