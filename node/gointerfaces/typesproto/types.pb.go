...
const file_types_types_proto_rawDesc = "" +
	...
	"\x05patch\x18\x03 \x01(\rR\x05patch\"\xb6\a\n" +
	...
	"\x11block_access_list\x18\x14 \x03(\v2\x1d.types.BlockAccessListAccountR\x0fblockAccessListB\x10\n" +
	"\x0e_blob_gas_usedB\x12\n" +
	"\x10_excess_blob_gasB\x19\n" +
	"\x17_block_access_list_hash\"W\n" +
