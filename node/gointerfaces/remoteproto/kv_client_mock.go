...
// Source: github.com/erigontech/erigon/node/gointerfaces/remoteproto (interfaces: KVClient)
//
...
// OpenStateSnapshots mocks base method.
func (m *MockKVClient) OpenStateSnapshots(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "OpenStateSnapshots", varargs...)
	ret0, _ := ret[0].(*emptypb.Empty)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// OpenStateSnapshots indicates an expected call of OpenStateSnapshots.
func (mr *MockKVClientMockRecorder) OpenStateSnapshots(ctx, in any, opts ...any) *MockKVClientOpenStateSnapshotsCall {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OpenStateSnapshots", reflect.TypeOf((*MockKVClient)(nil).OpenStateSnapshots), varargs...)
	return &MockKVClientOpenStateSnapshotsCall{Call: call}
}

// MockKVClientOpenStateSnapshotsCall wrap *gomock.Call
type MockKVClientOpenStateSnapshotsCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockKVClientOpenStateSnapshotsCall) Return(arg0 *emptypb.Empty, arg1 error) *MockKVClientOpenStateSnapshotsCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockKVClientOpenStateSnapshotsCall) Do(f func(context.Context, *emptypb.Empty, ...grpc.CallOption) (*emptypb.Empty, error)) *MockKVClientOpenStateSnapshotsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockKVClientOpenStateSnapshotsCall) DoAndReturn(f func(context.Context, *emptypb.Empty, ...grpc.CallOption) (*emptypb.Empty, error)) *MockKVClientOpenStateSnapshotsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
