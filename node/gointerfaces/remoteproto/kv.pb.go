...
type GetLatestReq struct {
	...
	MaxStep       *uint64 `protobuf:"varint,7,opt,name=max_step,json=maxStep,proto3,oneof" json:"max_step,omitempty"` // absent means unbounded; zero bounds the read at step 0
	BranchCache   bool    `protobuf:"varint,8,opt,name=branch_cache,json=branchCache,proto3" json:"branch_cache,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetLatestReq) GetMaxStep() uint64 {
...
func (x *GetLatestReq) GetBranchCache() bool {
	if x != nil {
		return x.BranchCache
	}
	return false
}
...
type CurrentDomainVersionReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *CurrentDomainVersionReq) Reset() {
	*x = CurrentDomainVersionReq{}
	mi := &file_remote_kv_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CurrentDomainVersionReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CurrentDomainVersionReq) ProtoMessage() {}

func (x *CurrentDomainVersionReq) ProtoReflect() protoreflect.Message {
	mi := &file_remote_kv_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CurrentDomainVersionReq.ProtoReflect.Descriptor instead.
func (*CurrentDomainVersionReq) Descriptor() ([]byte, []int) {
	return file_remote_kv_proto_rawDescGZIP(), []int{25}
}

func (x *CurrentDomainVersionReq) GetTxId() uint64 {
	if x != nil {
		return x.TxId
	}
	return 0
...
func (x *CurrentDomainVersionReq) GetDomain() uint32 {
	if x != nil {
		return x.Domain
	}
	return 0
...
type CurrentDomainVersionReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *CurrentDomainVersionReply) Reset() {
	*x = CurrentDomainVersionReply{}
	mi := &file_remote_kv_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CurrentDomainVersionReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CurrentDomainVersionReply) ProtoMessage() {}

func (x *CurrentDomainVersionReply) ProtoReflect() protoreflect.Message {
	mi := &file_remote_kv_proto_msgTypes[26]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CurrentDomainVersionReply.ProtoReflect.Descriptor instead.
func (*CurrentDomainVersionReply) Descriptor() ([]byte, []int) {
	return file_remote_kv_proto_rawDescGZIP(), []int{26}
}

func (x *CurrentDomainVersionReply) GetMajor() uint64 {
	if x != nil {
		return x.Major
	}
	return 0
...
func (x *CurrentDomainVersionReply) GetMinor() uint64 {
	if x != nil {
		return x.Minor
	}
	return 0
...
func (x *StepSizeReq) Reset() {
	*x = StepSizeReq{}
	mi := &file_remote_kv_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StepSizeReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StepSizeReq) ProtoMessage() {}

func (x *StepSizeReq) ProtoReflect() protoreflect.Message {
	mi := &file_remote_kv_proto_msgTypes[27]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StepSizeReq.ProtoReflect.Descriptor instead.
func (*StepSizeReq) Descriptor() ([]byte, []int) {
	return file_remote_kv_proto_rawDescGZIP(), []int{27}
}

func (x *StepSizeReq) GetTxId() uint64 {
	if x != nil {
		return x.TxId
	}
	return 0
...
func (x *StepSizeReply) Reset() {
	*x = StepSizeReply{}
	mi := &file_remote_kv_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StepSizeReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StepSizeReply) ProtoMessage() {}

func (x *StepSizeReply) ProtoReflect() protoreflect.Message {
	mi := &file_remote_kv_proto_msgTypes[28]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StepSizeReply.ProtoReflect.Descriptor instead.
func (*StepSizeReply) Descriptor() ([]byte, []int) {
	return file_remote_kv_proto_rawDescGZIP(), []int{28}
}

func (x *StepSizeReply) GetStep() uint64 {
	if x != nil {
		return x.Step
	}
	return 0
...
const file_remote_kv_proto_rawDesc = "" +
	...
	"\x05value\x18\x01 \x01(\x04R\x05value\"\xcf\x01\n" +
	...
	"\x06latest\x18\x06 \x01(\bR\x06latest\x12\x1e\n" +
	"\bmax_step\x18\a \x01(\x04H\x00R\amaxStep\x88\x01\x01\x12!\n" +
	"\fbranch_cache\x18\b \x01(\bR\vbranchCacheB\v\n" +
	"\t_max_step\".\n" +
	...
	"\x05limit\x18\x02 \x01(\x12R\x05limit\"B\n" +
	...
	"\n" +
	"start_from\x18\x01 \x01(\x04R\tstartFrom\"F\n" +
	"\x17CurrentDomainVersionReq\x12\x13\n" +
	"\x05tx_id\x18\x01 \x01(\x04R\x04txId\x12\x16\n" +
	"\x06domain\x18\x02 \x01(\rR\x06domain\"G\n" +
	"\x19CurrentDomainVersionReply\x12\x14\n" +
	"\x05major\x18\x01 \x01(\x04R\x05major\x12\x14\n" +
	"\x05minor\x18\x02 \x01(\x04R\x05minor\"\"\n" +
	...
	"\tRangeAsOf\x12\x14.remote.RangeAsOfReq\x1a\r.remote.Pairs\x12N\n" +
...
var file_remote_kv_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_remote_kv_proto_goTypes = []any{
	...
	(*HistoryStartFromReq)(nil),       // 26: remote.HistoryStartFromReq
	(*HistoryStartFromReply)(nil),     // 27: remote.HistoryStartFromReply
	(*CurrentDomainVersionReq)(nil),   // 28: remote.CurrentDomainVersionReq
	(*CurrentDomainVersionReply)(nil), // 29: remote.CurrentDomainVersionReply
	(*StepSizeReq)(nil),               // 30: remote.StepSizeReq
	(*StepSizeReply)(nil),             // 31: remote.StepSizeReply
	(*typesproto.H256)(nil),           // 32: types.H256
	(*typesproto.H160)(nil),           // 33: types.H160
	(*emptypb.Empty)(nil),             // 34: google.protobuf.Empty
	(*typesproto.VersionReply)(nil),   // 35: types.VersionReply
}
var file_remote_kv_proto_depIdxs = []int32{
	0,  // 0: remote.Cursor.op:type_name -> remote.Op
	32, // 1: remote.StorageChange.location:type_name -> types.H256
	33, // 2: remote.AccountChange.address:type_name -> types.H160
	...
	32, // 7: remote.StateChange.block_hash:type_name -> types.H256
	6,  // 8: remote.StateChange.changes:type_name -> remote.AccountChange
	34, // 9: remote.KV.Version:input_type -> google.protobuf.Empty
	...
	26, // 20: remote.KV.HistoryStartFrom:input_type -> remote.HistoryStartFromReq
	28, // 21: remote.KV.CurrentDomainVersion:input_type -> remote.CurrentDomainVersionReq
	30, // 22: remote.KV.StepSize:input_type -> remote.StepSizeReq
	35, // 23: remote.KV.Version:output_type -> types.VersionReply
	4,  // 24: remote.KV.Tx:output_type -> remote.Pair
	7,  // 25: remote.KV.StateChanges:output_type -> remote.StateChangeBatch
	11, // 26: remote.KV.Snapshots:output_type -> remote.SnapshotsReply
	23, // 27: remote.KV.Range:output_type -> remote.Pairs
	14, // 28: remote.KV.Sequence:output_type -> remote.SequenceReply
	16, // 29: remote.KV.GetLatest:output_type -> remote.GetLatestReply
	18, // 30: remote.KV.HistorySeek:output_type -> remote.HistorySeekReply
	20, // 31: remote.KV.IndexRange:output_type -> remote.IndexRangeReply
	23, // 32: remote.KV.HistoryRange:output_type -> remote.Pairs
	23, // 33: remote.KV.RangeAsOf:output_type -> remote.Pairs
	27, // 34: remote.KV.HistoryStartFrom:output_type -> remote.HistoryStartFromReply
	29, // 35: remote.KV.CurrentDomainVersion:output_type -> remote.CurrentDomainVersionReply
	31, // 36: remote.KV.StepSize:output_type -> remote.StepSizeReply
