...
func (UnimplementedETHBACKENDServer) Etherbase(context.Context, *EtherbaseRequest) (*EtherbaseReply, error) {
	return nil, status.Error(codes.Unimplemented, "method Etherbase not implemented")
}
func (UnimplementedETHBACKENDServer) NetVersion(context.Context, *NetVersionRequest) (*NetVersionReply, error) {
	return nil, status.Error(codes.Unimplemented, "method NetVersion not implemented")
}
func (UnimplementedETHBACKENDServer) NetPeerCount(context.Context, *NetPeerCountRequest) (*NetPeerCountReply, error) {
	return nil, status.Error(codes.Unimplemented, "method NetPeerCount not implemented")
}
...
func (UnimplementedETHBACKENDServer) Syncing(context.Context, *emptypb.Empty) (*SyncingReply, error) {
	return nil, status.Error(codes.Unimplemented, "method Syncing not implemented")
}
func (UnimplementedETHBACKENDServer) ProtocolVersion(context.Context, *ProtocolVersionRequest) (*ProtocolVersionReply, error) {
	return nil, status.Error(codes.Unimplemented, "method ProtocolVersion not implemented")
}
func (UnimplementedETHBACKENDServer) ClientVersion(context.Context, *ClientVersionRequest) (*ClientVersionReply, error) {
	return nil, status.Error(codes.Unimplemented, "method ClientVersion not implemented")
}
...
func (UnimplementedETHBACKENDServer) CanonicalBodyForStorage(context.Context, *CanonicalBodyForStorageRequest) (*CanonicalBodyForStorageReply, error) {
	return nil, status.Error(codes.Unimplemented, "method CanonicalBodyForStorage not implemented")
}
func (UnimplementedETHBACKENDServer) CanonicalHash(context.Context, *CanonicalHashRequest) (*CanonicalHashReply, error) {
	return nil, status.Error(codes.Unimplemented, "method CanonicalHash not implemented")
}
func (UnimplementedETHBACKENDServer) HeaderNumber(context.Context, *HeaderNumberRequest) (*HeaderNumberReply, error) {
	return nil, status.Error(codes.Unimplemented, "method HeaderNumber not implemented")
}
func (UnimplementedETHBACKENDServer) TxnLookup(context.Context, *TxnLookupRequest) (*TxnLookupReply, error) {
	return nil, status.Error(codes.Unimplemented, "method TxnLookup not implemented")
}
...
func (UnimplementedETHBACKENDServer) BlockForTxNum(context.Context, *BlockForTxNumRequest) (*BlockForTxNumResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BlockForTxNum not implemented")
}
...
func RegisterETHBACKENDServer(s grpc.ServiceRegistrar, srv ETHBACKENDServer) {
	// If the following call panics, it indicates UnimplementedETHBACKENDServer was
