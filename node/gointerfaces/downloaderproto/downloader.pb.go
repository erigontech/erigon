...
func (x *AddRequest) GetLogTarget() string {
	if x != nil {
		return x.LogTarget
	}
	return ""
...
const file_downloader_downloader_proto_rawDesc = "" +
	...
	"\ftorrent_hash\x18\x02 \x01(\v2\v.types.H160R\vtorrentHash\"V\n" +
	"\n" +
	"AddRequest\x12)\n" +
	"\x05items\x18\x01 \x03(\v2\x13.downloader.AddItemR\x05items\x12\x1d\n" +
	"\n" +
