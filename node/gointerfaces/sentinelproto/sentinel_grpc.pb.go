...
func (UnimplementedSentinelServer) SetSubscribeExpiry(context.Context, *RequestSubscribeExpiry) (*EmptyMessage, error) {
	return nil, status.Error(codes.Unimplemented, "method SetSubscribeExpiry not implemented")
}
func (UnimplementedSentinelServer) SubscribeGossip(*SubscriptionData, grpc.ServerStreamingServer[GossipData]) error {
	return status.Error(codes.Unimplemented, "method SubscribeGossip not implemented")
}
...
func (UnimplementedSentinelServer) RewardPeer(context.Context, *Peer) (*EmptyMessage, error) {
	return nil, status.Error(codes.Unimplemented, "method RewardPeer not implemented")
}
func (UnimplementedSentinelServer) PublishGossip(context.Context, *GossipData) (*EmptyMessage, error) {
	return nil, status.Error(codes.Unimplemented, "method PublishGossip not implemented")
}
...
func (UnimplementedSentinelServer) SendPeerRequest(context.Context, *RequestDataWithPeer) (*ResponseData, error) {
	return nil, status.Error(codes.Unimplemented, "method SendPeerRequest not implemented")
}
