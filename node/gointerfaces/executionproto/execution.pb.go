...
func (x *BlockBody) GetBlockAccessList() []*BlockAccessListAccount {
	if x != nil {
...
const file_execution_execution_proto_rawDesc = "" +
	...
	"\fcode_changes\x18\x06 \x03(\v2$.execution.BlockAccessListCodeChangeR\vcodeChanges\"\xad\x02\n" +
	"\tBlockBody\x12*\n" +
	"\n" +
	...
	"\vwithdrawals\x18\x05 \x03(\v2\x11.types.WithdrawalR\vwithdrawals\x12M\n" +
	"\x11block_access_list\x18\x06 \x03(\v2!.execution.BlockAccessListAccountR\x0fblockAccessList\"\\\n" +
	"\x05Block\x12)\n" +
...
var file_execution_execution_proto_msgTypes = make([]protoimpl.MessageInfo, 32)
var file_execution_execution_proto_goTypes = []any{
	...
	(*BlockBody)(nil),                    // 11: execution.BlockBody
	(*Block)(nil),                        // 12: execution.Block
	(*GetHeaderResponse)(nil),            // 13: execution.GetHeaderResponse
	(*GetTDResponse)(nil),                // 14: execution.GetTDResponse
	(*GetBodyResponse)(nil),              // 15: execution.GetBodyResponse
	(*GetHeaderHashNumberResponse)(nil),  // 16: execution.GetHeaderHashNumberResponse
	(*GetSegmentRequest)(nil),            // 17: execution.GetSegmentRequest
	(*InsertBlocksRequest)(nil),          // 18: execution.InsertBlocksRequest
	(*ForkChoice)(nil),                   // 19: execution.ForkChoice
	(*InsertionResult)(nil),              // 20: execution.InsertionResult
	(*ValidationRequest)(nil),            // 21: execution.ValidationRequest
	(*AssembleBlockRequest)(nil),         // 22: execution.AssembleBlockRequest
	(*AssembleBlockResponse)(nil),        // 23: execution.AssembleBlockResponse
	(*GetAssembledBlockRequest)(nil),     // 24: execution.GetAssembledBlockRequest
	(*AssembledBlockData)(nil),           // 25: execution.AssembledBlockData
	(*GetAssembledBlockResponse)(nil),    // 26: execution.GetAssembledBlockResponse
	(*GetBodiesBatchResponse)(nil),       // 27: execution.GetBodiesBatchResponse
	(*GetBodiesByHashesRequest)(nil),     // 28: execution.GetBodiesByHashesRequest
	(*GetBodiesByRangeRequest)(nil),      // 29: execution.GetBodiesByRangeRequest
	(*ReadyResponse)(nil),                // 30: execution.ReadyResponse
	(*FrozenBlocksResponse)(nil),         // 31: execution.FrozenBlocksResponse
	(*HasBlockResponse)(nil),             // 32: execution.HasBlockResponse
	(*typesproto.H256)(nil),              // 33: types.H256
	(*typesproto.H160)(nil),              // 34: types.H160
	(*typesproto.H2048)(nil),             // 35: types.H2048
	(*typesproto.Withdrawal)(nil),        // 36: types.Withdrawal
	(*typesproto.ExecutionPayload)(nil),  // 37: types.ExecutionPayload
	(*typesproto.BlobsBundle)(nil),       // 38: types.BlobsBundle
	(*typesproto.RequestsBundle)(nil),    // 39: types.RequestsBundle
...
var file_execution_execution_proto_depIdxs = []int32{
	...
	33, // 1: execution.ForkChoiceReceipt.latest_valid_hash:type_name -> types.H256
	0,  // 2: execution.ValidationReceipt.validation_status:type_name -> execution.ExecutionStatus
	33, // 3: execution.ValidationReceipt.latest_valid_hash:type_name -> types.H256
	33, // 4: execution.Header.parent_hash:type_name -> types.H256
	34, // 5: execution.Header.coinbase:type_name -> types.H160
	33, // 6: execution.Header.state_root:type_name -> types.H256
	33, // 7: execution.Header.receipt_root:type_name -> types.H256
	35, // 8: execution.Header.logs_bloom:type_name -> types.H2048
	33, // 9: execution.Header.prev_randao:type_name -> types.H256
	33, // 10: execution.Header.difficulty:type_name -> types.H256
	33, // 11: execution.Header.block_hash:type_name -> types.H256
	33, // 12: execution.Header.ommer_hash:type_name -> types.H256
	33, // 13: execution.Header.transaction_hash:type_name -> types.H256
	33, // 14: execution.Header.base_fee_per_gas:type_name -> types.H256
	33, // 15: execution.Header.withdrawal_hash:type_name -> types.H256
	33, // 16: execution.Header.parent_beacon_block_root:type_name -> types.H256
	33, // 17: execution.Header.requests_hash:type_name -> types.H256
	33, // 18: execution.Header.block_access_list_hash:type_name -> types.H256
	33, // 19: execution.BlockAccessListStorageChange.value:type_name -> types.H256
	33, // 20: execution.BlockAccessListSlotChanges.slot:type_name -> types.H256
	5,  // 21: execution.BlockAccessListSlotChanges.changes:type_name -> execution.BlockAccessListStorageChange
	33, // 22: execution.BlockAccessListBalanceChange.value:type_name -> types.H256
	34, // 23: execution.BlockAccessListAccount.address:type_name -> types.H160
	6,  // 24: execution.BlockAccessListAccount.storage_changes:type_name -> execution.BlockAccessListSlotChanges
	33, // 25: execution.BlockAccessListAccount.storage_reads:type_name -> types.H256
	...
	33, // 29: execution.BlockBody.block_hash:type_name -> types.H256
	4,  // 30: execution.BlockBody.uncles:type_name -> execution.Header
	36, // 31: execution.BlockBody.withdrawals:type_name -> types.Withdrawal
	10, // 32: execution.BlockBody.block_access_list:type_name -> execution.BlockAccessListAccount
	4,  // 33: execution.Block.header:type_name -> execution.Header
	11, // 34: execution.Block.body:type_name -> execution.BlockBody
	4,  // 35: execution.GetHeaderResponse.header:type_name -> execution.Header
	33, // 36: execution.GetTDResponse.td:type_name -> types.H256
	11, // 37: execution.GetBodyResponse.body:type_name -> execution.BlockBody
	33, // 38: execution.GetSegmentRequest.block_hash:type_name -> types.H256
	12, // 39: execution.InsertBlocksRequest.blocks:type_name -> execution.Block
	33, // 40: execution.ForkChoice.head_block_hash:type_name -> types.H256
	33, // 41: execution.ForkChoice.finalized_block_hash:type_name -> types.H256
	33, // 42: execution.ForkChoice.safe_block_hash:type_name -> types.H256
	0,  // 43: execution.InsertionResult.result:type_name -> execution.ExecutionStatus
	33, // 44: execution.ValidationRequest.hash:type_name -> types.H256
	33, // 45: execution.AssembleBlockRequest.parent_hash:type_name -> types.H256
	33, // 46: execution.AssembleBlockRequest.prev_randao:type_name -> types.H256
	34, // 47: execution.AssembleBlockRequest.suggested_fee_recipient:type_name -> types.H160
	36, // 48: execution.AssembleBlockRequest.withdrawals:type_name -> types.Withdrawal
	33, // 49: execution.AssembleBlockRequest.parent_beacon_block_root:type_name -> types.H256
	37, // 50: execution.AssembledBlockData.execution_payload:type_name -> types.ExecutionPayload
	33, // 51: execution.AssembledBlockData.block_value:type_name -> types.H256
	38, // 52: execution.AssembledBlockData.blobs_bundle:type_name -> types.BlobsBundle
	39, // 53: execution.AssembledBlockData.requests:type_name -> types.RequestsBundle
	25, // 54: execution.GetAssembledBlockResponse.data:type_name -> execution.AssembledBlockData
	11, // 55: execution.GetBodiesBatchResponse.bodies:type_name -> execution.BlockBody
	33, // 56: execution.GetBodiesByHashesRequest.hashes:type_name -> types.H256
	18, // 57: execution.Execution.InsertBlocks:input_type -> execution.InsertBlocksRequest
	21, // 58: execution.Execution.ValidateChain:input_type -> execution.ValidationRequest
	19, // 59: execution.Execution.UpdateForkChoice:input_type -> execution.ForkChoice
	22, // 60: execution.Execution.AssembleBlock:input_type -> execution.AssembleBlockRequest
	24, // 61: execution.Execution.GetAssembledBlock:input_type -> execution.GetAssembledBlockRequest
	40, // 62: execution.Execution.CurrentHeader:input_type -> google.protobuf.Empty
	17, // 63: execution.Execution.GetTD:input_type -> execution.GetSegmentRequest
	17, // 64: execution.Execution.GetHeader:input_type -> execution.GetSegmentRequest
	17, // 65: execution.Execution.GetBody:input_type -> execution.GetSegmentRequest
	17, // 66: execution.Execution.HasBlock:input_type -> execution.GetSegmentRequest
	29, // 67: execution.Execution.GetBodiesByRange:input_type -> execution.GetBodiesByRangeRequest
	28, // 68: execution.Execution.GetBodiesByHashes:input_type -> execution.GetBodiesByHashesRequest
	33, // 69: execution.Execution.IsCanonicalHash:input_type -> types.H256
	33, // 70: execution.Execution.GetHeaderHashNumber:input_type -> types.H256
	40, // 71: execution.Execution.GetForkChoice:input_type -> google.protobuf.Empty
	40, // 72: execution.Execution.Ready:input_type -> google.protobuf.Empty
	40, // 73: execution.Execution.FrozenBlocks:input_type -> google.protobuf.Empty
	20, // 74: execution.Execution.InsertBlocks:output_type -> execution.InsertionResult
	2,  // 75: execution.Execution.ValidateChain:output_type -> execution.ValidationReceipt
	1,  // 76: execution.Execution.UpdateForkChoice:output_type -> execution.ForkChoiceReceipt
	23, // 77: execution.Execution.AssembleBlock:output_type -> execution.AssembleBlockResponse
	26, // 78: execution.Execution.GetAssembledBlock:output_type -> execution.GetAssembledBlockResponse
	13, // 79: execution.Execution.CurrentHeader:output_type -> execution.GetHeaderResponse
	14, // 80: execution.Execution.GetTD:output_type -> execution.GetTDResponse
	13, // 81: execution.Execution.GetHeader:output_type -> execution.GetHeaderResponse
	15, // 82: execution.Execution.GetBody:output_type -> execution.GetBodyResponse
	32, // 83: execution.Execution.HasBlock:output_type -> execution.HasBlockResponse
	27, // 84: execution.Execution.GetBodiesByRange:output_type -> execution.GetBodiesBatchResponse
	27, // 85: execution.Execution.GetBodiesByHashes:output_type -> execution.GetBodiesBatchResponse
	3,  // 86: execution.Execution.IsCanonicalHash:output_type -> execution.IsCanonicalResponse
	16, // 87: execution.Execution.GetHeaderHashNumber:output_type -> execution.GetHeaderHashNumberResponse
	19, // 88: execution.Execution.GetForkChoice:output_type -> execution.ForkChoice
	30, // 89: execution.Execution.Ready:output_type -> execution.ReadyResponse
	31, // 90: execution.Execution.FrozenBlocks:output_type -> execution.FrozenBlocksResponse
...
func file_execution_execution_proto_init() {
	...
	file_execution_execution_proto_msgTypes[21].OneofWrappers = []any{}
	file_execution_execution_proto_msgTypes[25].OneofWrappers = []any{}
	type x struct{}
