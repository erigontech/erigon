...
// NotifySubscribed signals that the state change subscription is active.
// This is called by KvServer.StateChanges after subscribing to ensure
// no state change events are missed.
