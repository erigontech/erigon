...
func (c *Clique) VerifyHeaders(chain consensus.ChainReader, headers []*types.Header, seals []bool) (func(), <-chan error) {
...
func (c *Clique) Seal(ctx consensus.Cancel, chain consensus.ChainReader, block *types.Block, results chan<- consensus.ResultWithContext, stop <-chan struct{}) error {
	header := block.Header()
...
// current signer.
func (c *Clique) CalcDifficulty(chain consensus.ChainReader, _, _ uint64, _, parentNumber *big.Int, parentHash, _ common.Hash) *big.Int {
