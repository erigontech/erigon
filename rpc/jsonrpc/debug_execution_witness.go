...
func (api *DebugAPIImpl) buildExpectedPostState(
	...
	postDomains, err := execctx.NewSharedDomainsWithTrieConfig(ctx, tx, log.New(), commitment.TrieConfig{Variant: commitment.VariantHexPatriciaTrie, DeferBranchUpdates: false})
	if err != nil {
