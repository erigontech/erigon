...
func TestSearchTransactionsBefore(t *testing.T) {
	...
	t.Run("filter last block", func(t *testing.T) {
		...
		require.Equal(common.HexToHash("0x1a2f05721e7ab2f954a7a0c5a1dd31965af46afe8f2c9b4dfd5966477776b1cf"), results.Receipts[0]["transactionHash"].(common.Hash))
		require.Equal(common.HexToAddress("0x0D3ab14BBaD3D99F4203bd7a11aCB94882050E7e"), results.Receipts[0]["from"].(accounts.Address).Value())
		...
		require.Equal(common.HexToHash("0xdba09f6832198527f973481387dd0d98adfff7b86f6fd8809f0e406d24663fe0"), results.Receipts[1]["transactionHash"].(common.Hash))
		require.Equal(common.HexToAddress("0x71562b71999873DB5b286dF957af199Ec94617F7"), results.Receipts[1]["from"].(accounts.Address).Value())
