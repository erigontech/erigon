...
type EthAPI interface {
	...
	GetHeaderByNumber(ctx context.Context, number rpc.BlockNumber) (map[string]any, error)
	GetHeaderByHash(ctx context.Context, hash common.Hash) (map[string]any, error)
