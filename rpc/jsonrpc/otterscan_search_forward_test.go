...
func TestSearchTransactionsAfter(t *testing.T) {
	...
	t.Run("filter last block", func(t *testing.T) {
		...
		require.Equal(common.HexToHash("0xa0223bc954061713b2091d1f0af0103a29b084381ac20a423135c254def6d76b"), results.Receipts[0]["transactionHash"].(common.Hash))
		...
		require.Equal(common.HexToHash("0x1a2f05721e7ab2f954a7a0c5a1dd31965af46afe8f2c9b4dfd5966477776b1cf"), results.Receipts[1]["transactionHash"].(common.Hash))
