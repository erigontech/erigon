...
func (t *RPCTransaction) MarshalFastJSONTo(s *jsonstream.StackStream) error {
	...
	s.WriteObjectStart()
	jsonstream.HexPtr(s, "blockHash", t.BlockHash)
	jsonstream.HexPtr(s, "blockNumber", t.BlockNumber)
	jsonstream.HexPtr(s, "blockTimestamp", t.BlockTimestamp)
	jsonstream.Hex(s, "from", t.From)
	jsonstream.Hex(s, "gas", t.Gas)
	jsonstream.HexPtr(s, "gasPrice", t.GasPrice)
	jsonstream.HexPtrOmitempty(s, "maxPriorityFeePerGas", t.MaxPriorityFeePerGas)
	jsonstream.HexPtrOmitempty(s, "maxFeePerGas", t.MaxFeePerGas)
	jsonstream.Hex(s, "hash", t.Hash)
	jsonstream.Hex(s, "input", t.Input)
	jsonstream.Hex(s, "nonce", t.Nonce)
	jsonstream.HexPtr(s, "to", t.To)
	jsonstream.HexPtr(s, "transactionIndex", t.TransactionIndex)
	jsonstream.HexPtr(s, "value", t.Value)
	jsonstream.Hex(s, "type", t.Type)
	if t.Accesses != nil {
		s.Field("accessList")
		jsonstream.ArrayValue(s, *t.Accesses, writeAccessTuple)
	}
	jsonstream.HexPtrOmitempty(s, "chainId", t.ChainID)
	jsonstream.HexPtrOmitempty(s, "maxFeePerBlobGas", t.MaxFeePerBlobGas)
	...
	jsonstream.HexPtr(s, "v", t.V)
	jsonstream.HexPtrOmitempty(s, "yParity", t.YParity)
	jsonstream.HexPtr(s, "r", t.R)
	jsonstream.HexPtr(s, "s", t.S)
	s.WriteObjectEnd()
	return nil
}
