...
func (s *LazyFieldStream) WriteJSONValue(v any) error { s.ensure(); return s.inner.WriteJSONValue(v) }
func (s *LazyFieldStream) Mark() (int, int)           { s.ensure(); return s.inner.Mark() }
func (s *LazyFieldStream) Rewind(b, d int)            { s.ensure(); s.inner.Rewind(b, d) }
