...
var (
	...
	GnosisDencun0GenesisHash = libcommon.HexToHash("0x15b49fa96ab5cd1ffe6e76ed93c56fc6e4d5a38ece4eb6e8416873263a18f186")
)
...
var (
	...
	GnosisDencun0StateRoot = libcommon.HexToHash("0xe989527b3e44a1521ad2cdcfa8800b14d839f38a6c3c8b0adab647ea16a8adf9")
)
...
var (
	...
	GnosisDencun0Config = readChainSpec("chainspecs/gnosis_dencun0_devnet.json")
...
func ChainConfigByGenesisHash(genesisHash libcommon.Hash) *chain.Config {
	...
	case genesisHash == ChiadoGenesisHash:
		return ChiadoChainConfig
	case genesisHash == GnosisDencun0GenesisHash:
		return GnosisDencun0Config
	default:
		return nil
	}
