...
type ChainConfig struct {
	...
	TerminalTotalDifficulty *big.Int `json: "terminalTotalDifficulty, omitempty"` // EIP-3675: Upgrade consensus to Proof-of-Stake when terminal total difficulty is reached
