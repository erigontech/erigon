...
var (
	...
	GnosisWithdrawalsDevnet6GenesisHash = libcommon.HexToHash("0x9dbc7c5a7041724d2c7de8487ec39fbd2f029ef0db4864d6f4880ee5b7d675f5")
)
...
var (
	...
	GnosisWithdrawalsDevnet6GenesisStateRoot = libcommon.HexToHash("0x2c448cf97bfd1a20f4e26074db1668abe6ea3020fdee9c49c4d4f1f1302aeff4")
)
...
var (
	...
	GnosisWithdrawalsDevnet6ChainConfig = readChainSpec("chainspecs/gnosis_withdrawals_devnet_6.json")
...
func ChainConfigByChainName(chain string) *chain.Config {
	...
	case networkname.GnosisWithdrawalsDevnet6Name:
		return GnosisWithdrawalsDevnet6ChainConfig
	default:
		return nil
	}
}
...
func GenesisHashByChainName(chain string) *libcommon.Hash {
	...
	case networkname.GnosisWithdrawalsDevnet6Name:
		return &GnosisWithdrawalsDevnet6GenesisHash
	default:
		return nil
	}
}
...
func ChainConfigByGenesisHash(genesisHash libcommon.Hash) *chain.Config {
	...
	case genesisHash == ChiadoGenesisHash:
		return ChiadoChainConfig
	case genesisHash == GnosisWithdrawalsDevnet6GenesisHash:
		return GnosisWithdrawalsDevnet6ChainConfig
	default:
		return nil
	}
