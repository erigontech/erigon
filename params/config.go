...
var (
	...
	GnosisWithdrawalsDevnet2GenesisHash = libcommon.HexToHash("0xafc908eddd7937dff0bcca9c2524f019410a5973a545a43487f897f15e23c3dd")
)
...
var (
	...
	GnosisWithdrawalsDevnet2GenesisStateRoot = libcommon.HexToHash("0x628ee57ebf1b291272a58edccfa6486447ac467f11f83d484d3fe4b753f9119d")
)
...
var (
	...
	GnosisWithdrawalsDevnet2ChainConfig = readChainSpec("chainspecs/gnosis_withdrawals_devnet_2.json")
...
func ChainConfigByChainName(chain string) *chain.Config {
	...
	case networkname.GnosisWithdrawalsDevnet2Name:
		return GnosisWithdrawalsDevnet2ChainConfig
	default:
		return nil
	}
}
...
func GenesisHashByChainName(chain string) *libcommon.Hash {
	...
	case networkname.GnosisWithdrawalsDevnet2Name:
		return &GnosisWithdrawalsDevnet2GenesisHash
	default:
		return nil
	}
}
...
func ChainConfigByGenesisHash(genesisHash libcommon.Hash) *chain.Config {
	...
	case genesisHash == ChiadoGenesisHash:
		return ChiadoChainConfig
	case genesisHash == GnosisWithdrawalsDevnet2GenesisHash:
		return GnosisWithdrawalsDevnet2ChainConfig
	default:
		return nil
	}
