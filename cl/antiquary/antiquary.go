...
type Antiquary struct {
	...
	dirs                           datadir.Dirs
	downloader                     services.DownloaderClient
	logger                         log.Logger
