...
func (b *BeaconBlocksByRangeRequest) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the BeaconBlocksByRangeRequest object
func (b *BeaconBlocksByRangeRequest) GetTree() (*ssz.Node, error) {
