...
// Hash: 8c247b1097c97f2277d86c75e89d714c990105b722840a7441b2bb16b891ebd6
// Version: 0.1.2
package cltypes
...
func (e *ExecutionHeader) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (4) 'LogsBloom'
	if size := len(e.LogsBloom); size != 256 {
		err = ssz.ErrBytesLengthFn("ExecutionHeader.LogsBloom", size, 256)
		return
	}
	dst = append(dst, e.LogsBloom...)
	...
	// Field (11) 'BaseFeePerGas'
	if size := len(e.BaseFeePerGas); size != 32 {
		err = ssz.ErrBytesLengthFn("ExecutionHeader.BaseFeePerGas", size, 32)
		return
	}
	dst = append(dst, e.BaseFeePerGas...)
	...
	// Field (10) 'ExtraData'
	if size := len(e.ExtraData); size > 32 {
		err = ssz.ErrBytesLengthFn("ExecutionHeader.ExtraData", size, 32)
		return
	}
	dst = append(dst, e.ExtraData...)
...
func (e *ExecutionHeader) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the ExecutionHeader object
func (e *ExecutionHeader) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(e)
}
