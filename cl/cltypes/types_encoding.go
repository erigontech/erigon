...
// Hash: 9b61d1d70af64acd5e4f3ecbfb29379e7500947d0b82729ad11340b81cfee8dc
package cltypes
...
// MarshalSSZ ssz marshals the BeaconBlockBellatrixForStorage object
func (b *BeaconBlockBellatrixForStorage) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconBlockBellatrixForStorage object to a target array
func (b *BeaconBlockBellatrixForStorage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(592)
...
// UnmarshalSSZ ssz unmarshals the BeaconBlockBellatrixForStorage object
func (b *BeaconBlockBellatrixForStorage) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 592 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconBlockBellatrixForStorage object
func (b *BeaconBlockBellatrixForStorage) SizeSSZ() (size int) {
	size = 592
...
// HashTreeRoot ssz hashes the BeaconBlockBellatrixForStorage object
func (b *BeaconBlockBellatrixForStorage) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconBlockBellatrixForStorage object with a hasher
func (b *BeaconBlockBellatrixForStorage) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
