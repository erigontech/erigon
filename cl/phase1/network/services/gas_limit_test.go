...
func TestIsGasLimitTargetCompatible(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:           "minimum execution gas limit is not a compatible lower target",
			parentGasLimit: 5_000,
			gasLimit:       5_000,
			targetGasLimit: 0,
			want:           false,
		},
		{
			name:           "lower target resolves below the execution gas limit bound",
			parentGasLimit: 5_000,
			gasLimit:       4_997,
			targetGasLimit: 0,
			want:           true,
		...
		{
			name:           "maximum execution gas limit is not a compatible upper target",
			parentGasLimit: 9_223_372_036_854_775_807,
			gasLimit:       9_223_372_036_854_775_807,
			targetGasLimit: 18_446_744_073_709_551_615,
			want:           false,
		},
		{
			name:           "upper target resolves above the execution gas limit bound",
			parentGasLimit: 9_223_372_036_854_775_807,
			gasLimit:       9_232_379_236_109_516_797,
			targetGasLimit: 18_446_744_073_709_551_615,
			want:           true,
		},
		{
