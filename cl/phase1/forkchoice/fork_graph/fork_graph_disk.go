...
func NewForkGraphDisk(anchorState *state.CachingBeaconState) ForkGraph {
...
func (f *forkGraphDisk) GetState(blockRoot libcommon.Hash, alwaysCopy bool) (*state.CachingBeaconState, bool, error) {
