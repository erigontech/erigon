...
func (b *BeaconRpcP2P) SendColumnSidecarsByRootIdentifierReq(
	...
	_, pid, cgc, err := b.columnDataPeers.pickPeerRoundRobin(ctx, req)
	if err != nil {
...
func (b *BeaconRpcP2P) TestSendColumnSidecarsByRangeReqV1(
	ctx context.Context,
) ([]*cltypes.DataColumnSidecar, string, error) {
	req := &cltypes.DataColumnsByRootIdentifier{
