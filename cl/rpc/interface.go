...
type BeaconRpc interface {
	...
	SendColumnSidecarsByRootIdentifierReq(ctx context.Context, req *solid.ListSSZ[*cltypes.DataColumnsByRootIdentifier]) ([]*cltypes.DataColumnSidecar, string, uint64, error)
