...
func BenchmarkAggregateSigCached(b *testing.B) {
	...
	require.NoError(b, bls.LoadPublicKeyIntoCache(convertHexToPublicKey("a491d1b0ecd9bb917989f0e74f0dea0422eac4a873e5e2644f368dffb9a6e20fd6e10c1b77654d067c0618f6e5a7f79a"), false))
	require.NoError(b, bls.LoadPublicKeyIntoCache(convertHexToPublicKey("b301803f8b5ac4a1133581fc676dfedc60d891dd5fa99028805e5ea5b08d3491af75d0707adab3b70c6a6a580217bf81"), false))
	require.NoError(b, bls.LoadPublicKeyIntoCache(convertHexToPublicKey("b53d21a4cfd562c469cc81514d4ce5a6b577d8403d32a394dc265dd190b47fa9f829fdd7963afdf972e5e77854051f6f"), false))

	for b.Loop() {
		_, err := bls.VerifyAggregate(
