...
func GenesisWithoutStateToBlock(g *types.Genesis, arbosVersion uint64) (head *types.Header, withdrawals []*types.Withdrawal) {
	head = &types.Header{
...
func MustCommitGenesisWithoutState(g *types.Genesis, db kv.RwDB) *types.Block {
	...
	header, withdrawals := GenesisWithoutStateToBlock(g, 0)
