...
func ExecV3(ctx context.Context,
	execStage *StageState, u Unwinder, workerCount int, cfg ExecuteBlockCfg, txc wrap.TxContainer, db kv.RwDB,
	...
	if inMemExec {
		...
		var err error
		doms, err = state2.NewSharedDomains(applyTx, db, log.New())
