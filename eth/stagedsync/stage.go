...
type ExecFunc func(badBlockUnwind bool, s *StageState, unwinder Unwinder, txc wrap.TxContainer, logger log.LoggerI) error
...
type UnwindFunc func(u *UnwindState, s *StageState, txc wrap.TxContainer, logger log.LoggerI) error

// PruneFunc is the execution function for the stage to prune old data.
// * state - is the current state of the stage and contains stage data.
type PruneFunc func(p *PruneState, tx kv.RwTx, logger log.LoggerI) error
