...
var ToProto = map[uint]map[uint64]proto_sentry.MessageId{
	ETH65: {
		...
		NodeDataMsg:                   proto_sentry.MessageId_GET_NODE_DATA_65,
		GetReceiptsMsg:                proto_sentry.MessageId_GET_RECEIPTS_65,
		ReceiptsMsg:                   proto_sentry.MessageId_GET_RECEIPTS_65,
	...
	ETH66: {
		...
		NodeDataMsg:                   proto_sentry.MessageId_GET_NODE_DATA_66,
		GetReceiptsMsg:                proto_sentry.MessageId_GET_RECEIPTS_66,
		ReceiptsMsg:                   proto_sentry.MessageId_GET_RECEIPTS_66,
