...
func RecvTxMessage(ctx context.Context, sentry download.SentryClient, handleInboundMessage func(ctx context.Context, inreq *proto_sentry.InboundMessage, sentry download.SentryClient) error) {
