...
// BenchmarkBytesMarshalJSON compares a 64KB eth_getCode result encoded by json/v2, by
// WriteQuotedText (what the response writer calls for a hexutil.Bytes result) and by WriteHex.
