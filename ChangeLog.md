...
- rpc: `eth_newFilter` now rejects criteria exceeding `rpc.logs.querylimit` with `-32602` instead of creating a filter whose `eth_getFilterLogs` queries always fail — by @yperbasis
