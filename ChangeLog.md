...
## [3.4.4] "Splashing Saga" – TBD

v3.4.4 is a bugfix release recommended for all users.

**Bugfixes**

- execution/stagedsync: prune in-RAM overlay when execution unwind is a no-op (#21824, 21847) by @JkLondon  — third
  fix for the post-reorg `gas used mismatch`.
