...
func TestGetFullBlockByNumber(t *testing.T) {
	...
	signer1 := types.MakeSigner(params.TestChainConfig, 1, 1)
	signer2 := types.MakeSigner(params.TestChainConfig, 2, 2)
	signer3 := types.MakeSigner(params.TestChainConfig, 3, 3)
	signer4 := types.MakeSigner(params.TestChainConfig, 4, 4)
