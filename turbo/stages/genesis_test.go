...
func TestSokolHeaderRLP(t *testing.T) {
	...
	}
	{
		...
		enc := common.FromHex("")
		
		err = rlp.Decode(bytes.NewReader(enc), h3)
		require.NoError(t, err)
		...
		fmt.Printf("aa: %x\n", h3.Seal)
		res, err := rlp.EncodeToBytes(h3) // after encode getting source bytes
		fmt.Printf("res: %x\n", res)
		require.NoError(t, err)
