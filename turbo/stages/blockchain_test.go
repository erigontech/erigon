...
func TestEIP155Transition(t *testing.T) {
	...
	var (
		...
		gspec      = &core.Genesis{
			Config: &params.ChainConfig{ChainID: big.NewInt(1), TangerineWhistleBlock: big.NewInt(0), EIP155Block: big.NewInt(2), HomesteadBlock: new(big.Int)},
	...
	config := &params.ChainConfig{ChainID: big.NewInt(2), TangerineWhistleBlock: big.NewInt(0), EIP155Block: big.NewInt(2), HomesteadBlock: new(big.Int)}
