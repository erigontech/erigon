...
func NewDefaultStages(ctx context.Context,
	...
	borRetire services.BlockRetire,
	...
	return stagedsync.DefaultStages(ctx,
		...
		stagedsync.StageBorSnapshotsCfg(db, *controlServer.ChainConfig, dirs, borRetire, snapDownloader, blockReader, notifications.Events, cfg.HistoryV3, agg),
