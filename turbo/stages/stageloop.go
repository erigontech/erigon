...
func StageLoop(
	...
	for !stopped {
		...
		st, err1 := sync.Prepare(nil, chainConfig, nil, cc, &vm.Config{}, db, writeDB, "downloader", ethdb.DefaultStorageMode, ".", nil, 512*1024*1024, make(chan struct{}), nil, nil, func() error { return nil }, nil, initialCycle)
		if err1 != nil {
