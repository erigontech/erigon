	...
	Subcommands: []*cli.Command{
		{
			...
			}, debug.Flags, logging.Flags, utils.MetricFlags),
		},
		{
			Name:   "index",
		...
		},
		{
			...
			Usage:  "erigon snapshots uncompress a.seg | erigon snapshots compress b.seg",
			Before: func(ctx *cli.Context) error { return debug.Setup(ctx) },
			Flags:  joinFlags([]cli.Flag{}, debug.Flags, logging.Flags, utils.MetricFlags),
		},
		{
			Name:   "compress",
			Action: doCompress,
			Before: func(ctx *cli.Context) error { return debug.Setup(ctx) },
			Flags:  joinFlags([]cli.Flag{&utils.DataDirFlag}, debug.Flags, logging.Flags, utils.MetricFlags),
		},
		{
			Name:   "ram",
			Action: doRam,
