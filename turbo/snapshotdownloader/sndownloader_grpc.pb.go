...
type DownloaderClient interface {
	// Sends a greeting
	Download(ctx context.Context, in *DownloadSnapshotRequest, opts ...grpc.CallOption) (*SnapshotsInfo, error)
	Snapshots(ctx context.Context, in *SnapshotsInfoRequest, opts ...grpc.CallOption) (*SnapshotsInfoReply, error)
}
...
func (c *downloaderClient) Download(ctx context.Context, in *DownloadSnapshotRequest, opts ...grpc.CallOption) (*SnapshotsInfo, error) {
	out := new(SnapshotsInfo)
...
func (c *downloaderClient) Snapshots(ctx context.Context, in *SnapshotsInfoRequest, opts ...grpc.CallOption) (*SnapshotsInfoReply, error) {
...
type DownloaderServer interface {
	// Sends a greeting
	Download(context.Context, *DownloadSnapshotRequest) (*SnapshotsInfo, error)
	Snapshots(context.Context, *SnapshotsInfoRequest) (*SnapshotsInfoReply, error)
...
func (UnimplementedDownloaderServer) Download(context.Context, *DownloadSnapshotRequest) (*SnapshotsInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Download not implemented")
}
func (UnimplementedDownloaderServer) Snapshots(context.Context, *SnapshotsInfoRequest) (*SnapshotsInfoReply, error) {
...
func _Downloader_Snapshots_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DownloaderServer).Snapshots(ctx, req.(*SnapshotsInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
