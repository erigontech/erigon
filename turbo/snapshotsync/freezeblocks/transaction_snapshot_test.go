...
func TestTransactionSnapshotEncodeDecode(t *testing.T) {
	...
	segmentFile := filepath.Join(dir, snaptype.SegmentFileName(version.V1_0, 0, 1000, coresnaptype.Transactions.Enum()))
	idxFile := filepath.Join(dir, snaptype.IdxFileName(version.V1_0, 0, 1000, coresnaptype.Transactions.Name()))
