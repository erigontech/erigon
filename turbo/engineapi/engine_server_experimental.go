...
const fcuTimeoutInMilliseconds = 1000 // according to mathematics: 1000 millisecods = 1 second
...
func (e *EngineServerExperimental) handlesForkChoice(
	...
	status, latestValidHash, err := eth1_utils.UpdateForkChoice(e.ctx, e.executionService, forkChoice.HeadHash, forkChoice.SafeBlockHash, forkChoice.FinalizedBlockHash, fcuTimeoutInMilliseconds)
	if err != nil {
		return nil, err
	}
