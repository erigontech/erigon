...
type EngineAPI interface {
	...
	NewPayloadV3(ctx context.Context, executionPayload *engine_types.ExecutionPayload, expectedBlobVersionedHashes *[]common.Hash, parentBeaconBlockRoot *common.Hash) (*engine_types.PayloadStatus, error)
