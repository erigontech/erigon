...
var file_remote_kv_proto_rawDesc = []byte{
	...
	0x4e, 0x10, 0x1e, 0x12, 0x09, 0x0a, 0x05, 0x43, 0x4c, 0x4f, 0x53, 0x45, 0x10, 0x1f, 0x32, 0x64,
	...
	0x28, 0x01, 0x30, 0x01, 0x42, 0x1d, 0x5a, 0x0f, 0x2e, 0x2f, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65,
	0x3b, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x88, 0xb5, 0x18, 0x01, 0x90, 0xb5, 0x18, 0x00, 0x98,
	0xb5, 0x18, 0x00, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_remote_kv_proto_goTypes = []interface{}{
	...
	(*types.VersionReply)(nil), // 4: types.VersionReply
}
var file_remote_kv_proto_depIdxs = []int32{
	0, // 0: remote.Cursor.op:type_name -> remote.Op
	3, // 1: remote.KV.Version:input_type -> google.protobuf.Empty
	1, // 2: remote.KV.Tx:input_type -> remote.Cursor
	4, // 3: remote.KV.Version:output_type -> types.VersionReply
