...
type AllReply struct {
	...
	PendingTxsRlp [][]byte `protobuf:"bytes,1,rep,name=pendingTxsRlp,proto3" json:"pendingTxsRlp,omitempty"` // All currently processable transactions
	QueuedTxsRlp  [][]byte `protobuf:"bytes,2,rep,name=queuedTxsRlp,proto3" json:"queuedTxsRlp,omitempty"`   // Queued but non-processable transactions
}
...
func (x *AllReply) GetPendingTxsRlp() [][]byte {
	if x != nil {
		return x.PendingTxsRlp
	}
	return nil
}

func (x *AllReply) GetQueuedTxsRlp() [][]byte {
	if x != nil {
		return x.QueuedTxsRlp
	}
	return nil
}
...
var file_txpool_txpool_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x54, 0x0a, 0x08, 0x41, 0x6c, 0x6c, 0x52, 0x65,
	0x70, 0x6c, 0x79, 0x12, 0x24, 0x0a, 0x0d, 0x70, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x54, 0x78,
	0x73, 0x52, 0x6c, 0x70, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x0d, 0x70, 0x65, 0x6e, 0x64,
	0x69, 0x6e, 0x67, 0x54, 0x78, 0x73, 0x52, 0x6c, 0x70, 0x12, 0x22, 0x0a, 0x0c, 0x71, 0x75, 0x65,
	0x75, 0x65, 0x64, 0x54, 0x78, 0x73, 0x52, 0x6c, 0x70, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0c, 0x52,
	0x0c, 0x71, 0x75, 0x65, 0x75, 0x65, 0x64, 0x54, 0x78, 0x73, 0x52, 0x6c, 0x70, 0x2a, 0x6c, 0x0a,
	...
	0x4e, 0x41, 0x4c, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x05, 0x32, 0xca, 0x02, 0x0a, 0x06,
	...
	0x64, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x30, 0x01, 0x42, 0x11, 0x5a, 0x0f, 0x2e, 0x2f, 0x74, 0x78,
...
var file_txpool_txpool_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_txpool_txpool_proto_goTypes = []interface{}{
	...
	(*AllRequest)(nil),          // 8: txpool.AllRequest
	(*AllReply)(nil),            // 9: txpool.AllReply
...
var file_txpool_txpool_proto_depIdxs = []int32{
	10, // 0: txpool.TxHashes.hashes:type_name -> types.H256
	0,  // 1: txpool.AddReply.imported:type_name -> txpool.ImportResult
	10, // 2: txpool.TransactionsRequest.hashes:type_name -> types.H256
	11, // 3: txpool.Txpool.Version:input_type -> google.protobuf.Empty
	...
	8,  // 7: txpool.Txpool.All:input_type -> txpool.AllRequest
	6,  // 8: txpool.Txpool.OnAdd:input_type -> txpool.OnAddRequest
	12, // 9: txpool.Txpool.Version:output_type -> types.VersionReply
	...
	9,  // 13: txpool.Txpool.All:output_type -> txpool.AllReply
	7,  // 14: txpool.Txpool.OnAdd:output_type -> txpool.OnAddReply
