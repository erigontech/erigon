...
var file_p2psentry_sentry_proto_rawDesc = []byte{
	...
	0x28, 0x0e, 0x32, 0x11, 0x2e, 0x73, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x2e, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x49, 0x64, 0x52, 0x03, 0x69, 0x64, 0x73, 0x2a, 0xda, 0x05, 0x0a, 0x09, 0x4d,
	...
	0x2a, 0x20, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x12, 0x09, 0x0a, 0x05,
	0x45, 0x54, 0x48, 0x36, 0x35, 0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x45, 0x54, 0x48, 0x36, 0x36,
	0x10, 0x01, 0x32, 0xbe, 0x04, 0x0a, 0x06, 0x53, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x43, 0x0a,
	...
	0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x50, 0x0a, 0x15, 0x53, 0x65, 0x6e, 0x64, 0x4d,
	...
	0x79, 0x2e, 0x53, 0x65, 0x6e, 0x74, 0x50, 0x65, 0x65, 0x72, 0x73, 0x12, 0x37, 0x0a, 0x09, 0x53,
	...
	0x65, 0x70, 0x6c, 0x79, 0x12, 0x3d, 0x0a, 0x08, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73,
...
var file_p2psentry_sentry_proto_depIdxs = []int32{
	...
	15, // 3: sentry.SendMessageByIdRequest.peer_id:type_name -> types.H512
	3,  // 4: sentry.SendMessageToRandomPeersRequest.data:type_name -> sentry.OutboundMessageData
	15, // 5: sentry.SentPeers.peers:type_name -> types.H512
	15, // 6: sentry.PenalizePeerRequest.peer_id:type_name -> types.H512
	1,  // 7: sentry.PenalizePeerRequest.penalty:type_name -> sentry.PenaltyKind
	15, // 8: sentry.PeerMinBlockRequest.peer_id:type_name -> types.H512
	0,  // 9: sentry.InboundMessage.id:type_name -> sentry.MessageId
	15, // 10: sentry.InboundMessage.peer_id:type_name -> types.H512
	16, // 11: sentry.Forks.genesis:type_name -> types.H256
	16, // 12: sentry.StatusData.total_difficulty:type_name -> types.H256
	16, // 13: sentry.StatusData.best_hash:type_name -> types.H256
	...
	17, // 25: sentry.Sentry.PenalizePeer:output_type -> google.protobuf.Empty
	17, // 26: sentry.Sentry.PeerMinBlock:output_type -> google.protobuf.Empty
	7,  // 27: sentry.Sentry.SendMessageByMinBlock:output_type -> sentry.SentPeers
	7,  // 28: sentry.Sentry.SendMessageById:output_type -> sentry.SentPeers
	7,  // 29: sentry.Sentry.SendMessageToRandomPeers:output_type -> sentry.SentPeers
	7,  // 30: sentry.Sentry.SendMessageToAll:output_type -> sentry.SentPeers
	13, // 31: sentry.Sentry.SetStatus:output_type -> sentry.SetStatusReply
	10, // 32: sentry.Sentry.Messages:output_type -> sentry.InboundMessage
