...
# Fixed Docker build for Olym3 Testnet Season 3
# This script uses Go 1.22 instead of 1.24

echo "🐳 Building Erigon with Olym3 Testnet Season 3 using Docker (Go 1.22)..."

# Create a fixed Dockerfile for building
