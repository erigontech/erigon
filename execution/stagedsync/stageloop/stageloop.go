...
func NewDefaultStages(ctx context.Context,
	...
	return stagedsync.DefaultStages(
		...
		stagedsync.StageExecuteBlocksCfg(db, cfg.Prune, cfg.BatchSize, controlServer.ChainConfig, controlServer.Engine, &vm.Config{Tracer: tracingHooks}, notifications, cfg.StateStream, dbg.BadBlockHalt, dirs, blockReader, cfg.Genesis, cfg.Sync, cfg.ExperimentalBAL, readAheader, cfg.PostApplyHook),
...
func NewInMemoryExecution(
	...
	return stagedsync.New(
		...
		stagedsync.StateStages(ctx,
			...
			stagedsync.StageExecuteBlocksCfg(db, cfg.Prune, cfg.BatchSize, controlServer.ChainConfig, controlServer.Engine, &vm.Config{}, notifications, cfg.StateStream, true, cfg.Dirs, blockReader, cfg.Genesis, cfg.Sync, cfg.ExperimentalBAL, readAheader, cfg.PostApplyHook),
		),
