...
func NewDefaultStages(ctx context.Context,
	...
	return stagedsync.DefaultStages(
		...
		stagedsync.StageExecuteBlocksCfg(db, cfg.Prune, cfg.BatchSize, controlServer.ChainConfig, controlServer.Engine, &vm.Config{Tracer: tracingHooks}, notifications, cfg.StateStream, false /* badBlockHalt */, dirs, blockReader, blockRetire, controlServer.Hd, cfg.Genesis, cfg.Sync, cfg.ExperimentalBAL),
...
func NewPipelineStages(ctx context.Context,
	...
	return stagedsync.PipelineStages(ctx,
		...
		stagedsync.StageBlockHashesCfg(dirs.Tmp, blockWriter),
		stagedsync.StageSendersCfg(controlServer.ChainConfig, cfg.Sync, false /* badBlockHalt */, dirs.Tmp, cfg.Prune, blockReader, controlServer.Hd),
		stagedsync.StageExecuteBlocksCfg(db, cfg.Prune, cfg.BatchSize, controlServer.ChainConfig, controlServer.Engine, &vm.Config{Tracer: tracingHooks}, notifications, cfg.StateStream, false, dirs, blockReader, blockRetire, controlServer.Hd, cfg.Genesis, cfg.Sync, cfg.ExperimentalBAL),
		stagedsync.StageTxLookupCfg(cfg.Prune, dirs.Tmp, blockReader),
		stagedsync.StageFinishCfg(),
...
func NewInMemoryExecution(
	...
	return stagedsync.New(
		...
		stagedsync.StateStages(ctx,
			...
			// NewInMemoryExecution is used for fork-validation; no retire needed.
			stagedsync.StageExecuteBlocksCfg(db, cfg.Prune, cfg.BatchSize, controlServer.ChainConfig, controlServer.Engine, &vm.Config{}, notifications, cfg.StateStream, true, cfg.Dirs, blockReader, nil, controlServer.Hd, cfg.Genesis, cfg.Sync, cfg.ExperimentalBAL),
		),
