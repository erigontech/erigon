...
func TestLoadFromBAL_MatchesApplyWrites(t *testing.T) {
	...
	csInc.ApplyWrites(state.VersionedWrites{
		{Address: addrA, Path: state.BalancePath, ValU256: *uint256.NewInt(10)},
		{Address: addrA, Path: state.BalancePath, ValU256: *uint256.NewInt(99)},
		{Address: addrA, Path: state.NoncePath, ValU64: 5},
		{Address: addrB, Path: state.StoragePath, Key: slotS1, ValU256: *uint256.NewInt(1)},
		{Address: addrB, Path: state.StoragePath, Key: slotS1, ValU256: *uint256.NewInt(77)},
		{Address: addrB, Path: state.StoragePath, Key: slotS2, ValU256: *uint256.NewInt(42)},
		{Address: addrC, Path: state.BalancePath, ValU256: *uint256.NewInt(1000)},
		{Address: addrC, Path: state.CodePath, ValBytes: codeC},
		{Address: addrE, Path: state.BalancePath, ValU256: *uint256.NewInt(200)},
		{Address: addrE, Path: state.BalancePath, ValU256: *uint256.NewInt(500)},
	})
