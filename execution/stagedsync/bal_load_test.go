...
func TestLoadFromBAL_MatchesApplyWrites(t *testing.T) {
	...
	csInc.ApplyWrites(state.VersionedWrites{
		&state.VersionedWrite[uint256.Int]{WriteHeader: state.WriteHeader{Address: addrA, Path: state.BalancePath}, Val: *uint256.NewInt(10)},
		&state.VersionedWrite[uint256.Int]{WriteHeader: state.WriteHeader{Address: addrA, Path: state.BalancePath}, Val: *uint256.NewInt(99)},
		&state.VersionedWrite[uint64]{WriteHeader: state.WriteHeader{Address: addrA, Path: state.NoncePath}, Val: 5},
		&state.VersionedWrite[uint256.Int]{WriteHeader: state.WriteHeader{Address: addrB, Path: state.StoragePath, Key: slotS1}, Val: *uint256.NewInt(1)},
		&state.VersionedWrite[uint256.Int]{WriteHeader: state.WriteHeader{Address: addrB, Path: state.StoragePath, Key: slotS1}, Val: *uint256.NewInt(77)},
		&state.VersionedWrite[uint256.Int]{WriteHeader: state.WriteHeader{Address: addrB, Path: state.StoragePath, Key: slotS2}, Val: *uint256.NewInt(42)},
		&state.VersionedWrite[uint256.Int]{WriteHeader: state.WriteHeader{Address: addrC, Path: state.BalancePath}, Val: *uint256.NewInt(1000)},
		&state.VersionedWrite[accounts.Code]{WriteHeader: state.WriteHeader{Address: addrC, Path: state.CodePath}, Val: accounts.Code{Hash: accounts.InternCodeHash(crypto.Keccak256Hash(codeC)), Bytes: codeC}},
		&state.VersionedWrite[uint256.Int]{WriteHeader: state.WriteHeader{Address: addrE, Path: state.BalancePath}, Val: *uint256.NewInt(200)},
		&state.VersionedWrite[uint256.Int]{WriteHeader: state.WriteHeader{Address: addrE, Path: state.BalancePath}, Val: *uint256.NewInt(500)},
	})
