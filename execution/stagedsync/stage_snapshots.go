...
func pruneBlockSnapshots(ctx context.Context, cfg SnapshotsCfg, logger log.Logger) (bool, error) {
	...
	// PruneTo keeps at least the retention window, so FrozenBlocks never reaches 0.
	...
	return cfg.blockRetire.RemoveBlockSnapshotsBelow(ctx, pruneTo, func(l []string) error {
