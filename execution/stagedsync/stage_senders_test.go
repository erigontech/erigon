...
func TestSenders(t *testing.T) {
	...
	signer1 := types.MakeSigner(chain.AllProtocolChanges, *chain.AllProtocolChanges.BerlinBlock, 0)
	...
	signer2 := types.MakeSigner(chain.AllProtocolChanges, *chain.AllProtocolChanges.BerlinBlock, 0)
	...
	cfg := stagedsync.StageSendersCfg(chain.AllProtocolChanges, ethconfig.Defaults.Sync, false, "", prune.Mode{}, br, nil)
