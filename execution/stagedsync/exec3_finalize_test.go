...
func TestNormalizeWriteSet_StorageNoOp(t *testing.T) {
	...
	result, _ := writeSet.Normalize(vm, 0, 1, 0, nil, nil, true, false, false)
...
func TestNormalizeWriteSet_StorageNewKey(t *testing.T) {
	...
	result, _ := writeSet.Normalize(vm, 0, 0, 0, nil, nil, true, false, false)
	storageCount := countPath(result, state.StoragePath)
...
func TestNormalizeWriteSet_StaleIncarnation(t *testing.T) {
	...
	result, _ := allWrites.Normalize(vm, 0, 5, 1, nil, nil, true, false, false)
	storageCount := countPath(result, state.StoragePath)
...
func TestNormalizeWriteSet_StorageOnlyAddress(t *testing.T) {
	...
	result, _ := writeSet.Normalize(vm, 0, 0, 0, reader, nil, true, false, false)
...
func TestNormalizeWriteSet_StorageAllNoOps(t *testing.T) {
	...
	result, _ := writeSet.Normalize(vm, 0, 1, 0, reader, nil, true, false, false)
...
func TestNormalizeWriteSet_EmptyAccountRemoval(t *testing.T) {
	...
	result, _ := writeSet.Normalize(vm, 0, 5, 0, reader, nil, true, false, false)
...
func TestNormalizeWriteSet_AuraSystemAddressRetained(t *testing.T) {
	...
	run := func(isAura bool) *state.WriteSet {
		...
		normalized, _ := writeSet.Normalize(vm, 0, 5, 0, reader, nil, true, isAura, false)
		return normalized
	}
...
func TestNormalizeWriteSet_CodePathTravelsWithCodeHash(t *testing.T) {
	...
	result, _ := rawWrites.Normalize(vm, 0, txIndex, 1, nil, nil, true, false, false)
...
func TestNormalizeWriteSet_CodePathRecoveredFromStateReader(t *testing.T) {
	...
	result, _ := rawWrites.Normalize(vm, 0, txIndex, 0, reader, nil, true, false, false)
...
func TestNormalizeWriteSet_MetamorphicSameTxRecreateKeepsWrites(t *testing.T) {
	...
	result, _ := ws.Normalize(vm, 0, 1, 0, nil, nil, true, false, false)
...
func TestNormalizeWriteSet_StaleIncarnationSelfDestructIgnored(t *testing.T) {
	...
	result, _ := ws.Normalize(vm, 0, 5, 1, nil, nil, true, false, false)
...
func TestNormalizeWriteSet_PostSelfDestructZeroStorageDroppedViaHistory(t *testing.T) {
	...
	dropped, _ := zeroWrite.Normalize(vm, 0, 5, 0, reader, nil, true, false, false)
	...
	kept, _ := nonZero.Normalize(vm, 0, 5, 0, reader, nil, true, false, false)
...
func TestNormalizeWriteSet_SelfDestructEarlierThenCreateContractZeroesFields(t *testing.T) {
	...
	created := newWS().
		...
		build()
	res, _ := created.Normalize(vm, 0, 5, 0, nil, nil, true, false, false)
	...
	res2, _ := resurrect.Normalize(vm, 0, 5, 0, nil, nil, true, false, false)
...
func TestNormalizeWriteSet_StorageNoOpViaStateReaderPreBlock(t *testing.T) {
	...
	dropped, _ := sameVal.Normalize(vm, 0, 1, 0, reader, nil, true, false, false)
	...
	kept, _ := diffVal.Normalize(vm, 0, 1, 0, reader, nil, true, false, false)
	s, ok := kept.GetStorage(addr, slot)
