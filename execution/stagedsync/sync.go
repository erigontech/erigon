...
func (s *Sync) RunUnwind(db kv.RwDB, sd *sd.SharedDomains, tx kv.TemporalRwTx) error {
...
func (s *Sync) RunNoInterrupt(db kv.RwDB, sd *sd.SharedDomains, tx kv.TemporalRwTx) (bool, error) {
	var hasMore bool
...
func (s *Sync) Run(db kv.TemporalRwDB, sd *sd.SharedDomains, tx kv.TemporalRwTx, initialCycle, firstCycle bool) (bool, error) {
	s.prevUnwindPoint = nil
	s.timings = s.timings[:0]
...
func (s *Sync) runStage(stage *Stage, db kv.RwDB, doms *sd.SharedDomains, rwTx kv.TemporalRwTx, initialCycle, firstCycle bool, badBlockUnwind bool) (bool, error) {
	start := time.Now()
...
func (s *Sync) unwindStage(initialCycle bool, stage *Stage, db kv.RwDB, sd *sd.SharedDomains, tx kv.TemporalRwTx) error {
	start := time.Now()
