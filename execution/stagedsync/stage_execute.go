...
func SpawnExecuteBlocksStage(s *StageState, u Unwinder, doms *execstate.ExecutionContext, rwTx kv.TemporalRwTx, toBlock uint64, ctx context.Context, cfg ExecuteBlockCfg, logger log.Logger) (err error) {
...
func UnwindExecutionStage(u *UnwindState, s *StageState, doms *execstate.ExecutionContext, rwTx kv.TemporalRwTx, ctx context.Context, cfg ExecuteBlockCfg, logger log.Logger) (err error) {
