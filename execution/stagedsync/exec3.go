...
func computeAndCheckCommitmentV3(ctx context.Context, header *types.Header, applyTx kv.TemporalRwTx, doms *execctx.SharedDomains, cfg ExecuteBlockCfg, e *StageState, parallel bool, logger log.Logger, u Unwinder, isBlockProduction bool, logBeforeFlush func()) (ok bool, times FlushAndComputeCommitmentTimes, err error) {
	if header == nil {
