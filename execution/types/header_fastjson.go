...
func (h *Header) MarshalFastJSONTo(s *jsonstream.StackStream) error {
	...
	jsonstream.HexOmitempty(s, "auraStep", hexutil.Uint64(h.AuRaStep))
	jsonstream.HexOmitempty(s, "auraSeal", hexutil.Bytes(h.AuRaSeal))
	jsonstream.HexPtr(s, "baseFeePerGas", (*hexutil.U256)(h.BaseFee))
	jsonstream.HexPtr(s, "withdrawalsRoot", h.WithdrawalsHash)
	jsonstream.HexPtr(s, "blobGasUsed", (*hexutil.Uint64)(h.BlobGasUsed))
	jsonstream.HexPtr(s, "excessBlobGas", (*hexutil.Uint64)(h.ExcessBlobGas))
	jsonstream.HexPtr(s, "parentBeaconBlockRoot", h.ParentBeaconBlockRoot)
	jsonstream.HexPtr(s, "requestsHash", h.RequestsHash)
	jsonstream.HexPtr(s, "blockAccessListHash", h.BlockAccessListHash)
	jsonstream.HexPtrOmitempty(s, "slotNumber", (*hexutil.Uint64)(h.SlotNumber))
	hash := h.Hash()
