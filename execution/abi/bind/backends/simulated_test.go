...
func TestSimulatedBackend(t *testing.T) {
	...
	genAlloc := make(genesis.GenesisAlloc)
	genAlloc[auth.From] = genesis.GenesisAccount{Balance: big.NewInt(9223372036854775807)}
...
func TestSimulatedBackend_EstimateGas(t *testing.T) {
	...
	sim := NewSimulatedBackend(t, genesis.GenesisAlloc{addr: {Balance: big.NewInt(common.Ether)}}, 10000000)
...
func TestSimulatedBackend_EstimateGasWithPrice(t *testing.T) {
	...
	sim := NewSimulatedBackend(t, genesis.GenesisAlloc{addr: {Balance: big.NewInt(common.Ether*2 + 2e17)}}, 10000000)
