...
func TestTypeCheck(t *testing.T) {
	for i, test := range []struct {
		...
		{"address[]", nil, []common.Address{common.NewAddress(1)}, ""},
		{"address[1]", nil, []common.Address{common.NewAddress(1)}, ""},
		{"address[1]", nil, [1]common.Address{common.NewAddress(1)}, ""},
		{"address[2]", nil, [1]common.Address{common.NewAddress(1)}, "abi: cannot use [1]array as type [2]array as argument"},
		{"bytes32", nil, [32]byte{}, ""},
		{"bytes31", nil, [31]byte{}, ""},
		{"bytes30", nil, [30]byte{}, ""},
		{"bytes29", nil, [29]byte{}, ""},
		...
		{"bytes20", nil, common.ZeroAddress, ""},
		{"address", nil, [20]byte{}, ""},
		{"address", nil, common.ZeroAddress, ""},
