...
func TestExecutionSpecBlockchainDevnet(t *testing.T) {
	...
	// EIP-7928: max items cap and slot uniqueness added (fix/eip-7928-max-items). Tests still skipped pending EIP-8037 (PR#19596).
	bt.skipLoad(`^for_amsterdam/amsterdam/eip7928_block_level_access_lists/`)                                                                                   // needs EIP-8037 state creation gas cost (PR#19596)
