...
// testcontract.sol
//go:generate solc --allow-paths ., --abi --bin --overwrite --optimize --evm-version petersburg -o build testcontract.sol
...
// selfDestructor.sol
//go:generate solc --allow-paths ., --abi --bin --overwrite --optimize --evm-version petersburg -o build selfDestructor.sol
