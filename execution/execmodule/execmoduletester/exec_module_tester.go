...
func New(tb testing.TB, opts ...Option) *ExecModuleTester {
	...
	mock.Sync = stagedsync.New(
		...
		stagedsync.DefaultStages(
			mock.Ctx,
			stagedsync.StageSnapshotsCfg(mock.DB, mock.ChainConfig, cfg.Sync, dirs, blockRetire, snapDownloader, mock.BlockReader, mock.Notifications, false, false, false, nil, pruneMode, nil),
