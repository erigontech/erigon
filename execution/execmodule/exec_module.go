...
func (e *ExecModule) HasBlock(ctx context.Context, blockHash *common.Hash, _ *uint64) (bool, error) {
	...
	// canonical hash at this height. Without this check, CL callers treat
	// the stale hash as present, take the walker's early-exit, and skip
	// the re-fetch the recovery needs.
