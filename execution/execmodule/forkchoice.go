...
func (e *ExecModule) unwindIfNeeded(
	...
	// Unwind detaches both cache readers. If this fork choice commits, Commit
	// clears the caches before publishing the rewound generation; a failed
	// transaction leaves the durable generation unchanged.
	if fcuHeader.Number.Sign() > 0 {
