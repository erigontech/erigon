...
// Source: github.com/erigontech/erigon/execution/protocol/rules (interfaces: ChainHeaderReader)
//
// Generated by this command:
//
//	mockgen -typed=true -destination=./chain_header_reader_mock.go -package=rules . ChainHeaderReader
//
