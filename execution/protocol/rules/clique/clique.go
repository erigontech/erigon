...
// Clique is the proof-of-authority rules engine proposed to support the
...
// New creates a Clique proof-of-authority rules engine with the initial
...
func NewCliqueAPI(db kv.RoDB, engine rules.EngineReader, blockReader services.FullBlockReader) rpc.API {
	var c *Clique
