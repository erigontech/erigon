...
// Source: github.com/erigontech/erigon/execution/protocol/rules (interfaces: ChainReader)
//
// Generated by this command:
//
//	mockgen -typed=true -destination=./chain_reader_mock.go -package=rules . ChainReader
//
