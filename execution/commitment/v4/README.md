...
Commitment v4 is a self-contained commitment trie selected with the
`commitment-v4` trie variant. It reads commitment records during the fold and computes the root
...
The v4 key space is disjoint from V1 `HexToCompact` commitment keys. It is not disjoint from V2
...
full four-field account RLP. Record encoding happens during the fold; persistence uses v4-local
