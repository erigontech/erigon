...
func TestWarmupV3KeyAndStepAccountDescent(t *testing.T) {
...
func TestWarmupV3KeyPlaneCrossing(t *testing.T) {
...
func TestWarmupV3StepSelfExtensionAndTruncated(t *testing.T) {
...
func TestWarmupV3StepUsesPlaneDepthAndExtensionLength(t *testing.T) {
...
func TestWarmupV3KeyShapes(t *testing.T) {
...
func TestWarmupV3ReadsAccountPlaneRecords(t *testing.T) {
	ctx := newMockContext()
	hashedKey := make([]byte, 64)
	hashedKey[0] = 2
...
func TestWarmupV3StepStopsOnEmptyOrMissingRecord(t *testing.T) {
...
func TestWarmupV3ReadsStoragePlaneRecord(t *testing.T) {
	hashedKey := make([]byte, 128)
	hashedKey[0] = 2
	hashedKey[1] = 3
	hashedKey[64] = 4
...
func TestWarmupV3StorageDescentReachesBeyondRoot(t *testing.T) {
