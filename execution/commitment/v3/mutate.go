...
var (
	ErrInsertPath        = errors.New("commitment v3: invalid insert path")
	ErrInsertStoredChild = errors.New("commitment v3: cannot insert below a stored child")
	ErrRemovePath        = errors.New("commitment v3: invalid remove path")
	ErrRemoveNotFound    = errors.New("commitment v3: remove path not found")
	ErrRemoveStoredChild = errors.New("commitment v3: cannot remove below a stored child")
)
