...
var (
	errAccountLeafEmpty     = errors.New("commitment v3: empty account leaf")
	errAccountLeafFlags     = errors.New("commitment v3: invalid account leaf flags")
	errAccountLeafTruncated = errors.New("commitment v3: truncated account leaf")
)
