...
var PrecompiledContractsHomestead = PrecompiledContracts{
	accounts.BytesToAddress([]byte{1}): &ecrecover{},
	accounts.BytesToAddress([]byte{2}): &sha256hash{},
	accounts.BytesToAddress([]byte{3}): &ripemd160hash{},
	accounts.BytesToAddress([]byte{4}): &dataCopy{},
}
...
var PrecompiledContractsByzantium = PrecompiledContracts{
	...
	accounts.BytesToAddress([]byte{3}): &ripemd160hash{},
	accounts.BytesToAddress([]byte{4}): &dataCopy{},
	accounts.BytesToAddress([]byte{5}): &bigModExp{eip2565: false},
	accounts.BytesToAddress([]byte{6}): &bn254AddByzantium{},
	accounts.BytesToAddress([]byte{7}): &bn254ScalarMulByzantium{},
	accounts.BytesToAddress([]byte{8}): &bn254PairingByzantium{},
}
...
var PrecompiledContractsIstanbul = PrecompiledContracts{
	...
	accounts.BytesToAddress([]byte{4}): &dataCopy{},
	accounts.BytesToAddress([]byte{5}): &bigModExp{eip2565: false},
	accounts.BytesToAddress([]byte{6}): &bn254AddIstanbul{},
	accounts.BytesToAddress([]byte{7}): &bn254ScalarMulIstanbul{},
	accounts.BytesToAddress([]byte{8}): &bn254PairingIstanbul{},
	accounts.BytesToAddress([]byte{9}): &blake2F{},
}
...
var PrecompiledContractsBerlin = PrecompiledContracts{
	...
	accounts.BytesToAddress([]byte{3}): &ripemd160hash{},
	accounts.BytesToAddress([]byte{4}): &dataCopy{},
	accounts.BytesToAddress([]byte{5}): &bigModExp{eip2565: true},
	accounts.BytesToAddress([]byte{6}): &bn254AddIstanbul{},
	accounts.BytesToAddress([]byte{7}): &bn254ScalarMulIstanbul{},
	accounts.BytesToAddress([]byte{8}): &bn254PairingIstanbul{},
	accounts.BytesToAddress([]byte{9}): &blake2F{},
...
var PrecompiledContractsCancun = PrecompiledContracts{
	accounts.BytesToAddress([]byte{0x01}): &ecrecover{},
	accounts.BytesToAddress([]byte{0x02}): &sha256hash{},
	accounts.BytesToAddress([]byte{0x03}): &ripemd160hash{},
	accounts.BytesToAddress([]byte{0x04}): &dataCopy{},
	accounts.BytesToAddress([]byte{0x05}): &bigModExp{eip2565: true},
	accounts.BytesToAddress([]byte{0x06}): &bn254AddIstanbul{},
	accounts.BytesToAddress([]byte{0x07}): &bn254ScalarMulIstanbul{},
	accounts.BytesToAddress([]byte{0x08}): &bn254PairingIstanbul{},
	accounts.BytesToAddress([]byte{0x09}): &blake2F{},
	accounts.BytesToAddress([]byte{0x0a}): &pointEvaluation{},
}
...
var PrecompiledContractsNapoli = PrecompiledContracts{
	...
	accounts.BytesToAddress([]byte{0x08}):       &bn254PairingIstanbul{},
	accounts.BytesToAddress([]byte{0x09}):       &blake2F{},
	accounts.BytesToAddress([]byte{0x01, 0x00}): &p256Verify{},
}
...
var PrecompiledContractsBhilai = PrecompiledContracts{
	...
	accounts.BytesToAddress([]byte{0x08}):       &bn254PairingIstanbul{},
	accounts.BytesToAddress([]byte{0x09}):       &blake2F{},
	accounts.BytesToAddress([]byte{0x0b}):       &bls12381G1Add{},
	accounts.BytesToAddress([]byte{0x0c}):       &bls12381G1MultiExp{},
	accounts.BytesToAddress([]byte{0x0d}):       &bls12381G2Add{},
	accounts.BytesToAddress([]byte{0x0e}):       &bls12381G2MultiExp{},
	accounts.BytesToAddress([]byte{0x0f}):       &bls12381Pairing{},
	accounts.BytesToAddress([]byte{0x10}):       &bls12381MapFpToG1{},
	accounts.BytesToAddress([]byte{0x11}):       &bls12381MapFp2ToG2{},
	accounts.BytesToAddress([]byte{0x01, 0x00}): &p256Verify{},
}
...
var PrecompiledContractsOsaka = PrecompiledContracts{
	...
	accounts.BytesToAddress([]byte{0x03}):       &ripemd160hash{},
	accounts.BytesToAddress([]byte{0x04}):       &dataCopy{},
	accounts.BytesToAddress([]byte{0x05}):       &bigModExp{osaka: true},
	accounts.BytesToAddress([]byte{0x06}):       &bn254AddIstanbul{},
	accounts.BytesToAddress([]byte{0x07}):       &bn254ScalarMulIstanbul{},
	accounts.BytesToAddress([]byte{0x08}):       &bn254PairingIstanbul{},
	accounts.BytesToAddress([]byte{0x09}):       &blake2F{},
	...
	accounts.BytesToAddress([]byte{0x10}):       &bls12381MapFpToG1{},
	accounts.BytesToAddress([]byte{0x11}):       &bls12381MapFp2ToG2{},
	accounts.BytesToAddress([]byte{0x01, 0x00}): &p256Verify{eip7951: true},
}
