...
type IntraBlockState interface {
	...
	GetState(addr accounts.Address, key types.StorageKey) (uint256.Int, error)
...
type (
	...
	*/
	...
	StorageChangeHook = func(addr accounts.Address, slot types.StorageKey, prev, new uint256.Int)
