...
func TestValueTiebreaker_BalancePath(t *testing.T) {
	...
	valid := validateRead(vm, vm.load(addr), 10, addr, BalancePath, accounts.NilKey, StorageRead, Version{TxIndex: UnknownDep},
...
func TestValueTiebreaker_NoncePath(t *testing.T) {
	...
	valid := validateRead(vm, vm.load(addr), 10, addr, NoncePath, accounts.NilKey, StorageRead, Version{TxIndex: UnknownDep},
