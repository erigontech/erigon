...
// changer.sol
//go:generate solc --allow-paths ., --abi --bin --overwrite --optimize --evm-version petersburg -o build changer.sol
//go:generate abigen -abi build/Changer.abi -bin build/Changer.bin -pkg contracts -type changer -out ./gen_changer.go

// revive.sol
//go:generate solc --allow-paths ., --abi --bin --overwrite --optimize --evm-version petersburg -o build revive.sol
//go:generate abigen -abi build/Revive.abi -bin build/Revive.bin -pkg contracts -type revive -out ./gen_revive.go

// selfdestruct.sol
//go:generate solc --allow-paths ., --abi --bin --overwrite --optimize --evm-version petersburg -o build selfdestruct.sol
...
// poly.sol
//go:generate solc --allow-paths ., --abi --bin --overwrite --optimize --evm-version petersburg -o build poly.sol
//go:generate abigen -abi build/Poly.abi -bin build/Poly.bin -pkg contracts -type poly -out ./gen_poly.go

// revive2.sol
//go:generate solc --allow-paths ., --abi --bin --overwrite --optimize --evm-version petersburg -o build revive2.sol
