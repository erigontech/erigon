...
* [Build Erigon from source](build-Erigon-from-source.md): Build the Erigon source code directly on your system. This is the most complex option and requires following the [Software Requirements](../software-requirements.md).
