...
<table data-view="cards"><thead><tr><th></th><th></th></tr></thead><tbody><tr><td><h4><i class="fa-docker">:docker:</i></h4></td><td><ol><li><a href="./#docker"><strong>Docker</strong></a></li></ol></td></tr><tr><td><h4><i class="fa-gear">:gear:</i></h4></td><td><ol start="2"><li><a href="./#build-from-source"><strong>Build From Source</strong></a></li></ol></td></tr></tbody></table>
{% endtab %}

{% tab title="Windows" %}
<table data-view="cards"><thead><tr><th></th><th></th></tr></thead><tbody><tr><td><h4><i class="fa-docker">:docker:</i></h4></td><td><ol><li><a href="./#docker"><strong>Docker</strong></a></li></ol></td></tr><tr><td><h4><i class="fa-windows">:windows:</i></h4></td><td><ol start="2"><li><a href="./#native-compilation"><strong>Native Compilation</strong></a></li></ol></td></tr><tr><td><h4><i class="fa-linux">:linux:</i></h4></td><td><ol start="3"><li><a href="./#window-subsystem-for-linux-wsl"><strong>Windows Subsystem for Linux (WSL)</strong></a></li></ol></td></tr></tbody></table>
{% endtab %}
{% endtabs %}
...
#### 2.1 Generate the Checksum of Your Downloaded File <a href="#generate-the-checksum-of-your-downloaded-file" id="generate-the-checksum-of-your-downloaded-file"></a>
...
#### 2.2 Compare the Checksums <a href="#compare-the-checksums" id="compare-the-checksums"></a>
...
#### 2.1 Clone the Erigon repository <a href="#clone-the-erigon-repository" id="clone-the-erigon-repository"></a>
...
#### 2.2 Check Out the Desired Stable Version (Tag) <a href="#check-out-the-desired-stable-version-tag" id="check-out-the-desired-stable-version-tag"></a>
...
#### 2.3 Compile the Software <a href="#compile-the-software" id="compile-the-software"></a>
