...
"$(dirname "$0")/run_rpc_tests.sh" mainnet lupin012/fix_tests_with_commitment "$DISABLED_TESTS" "$WORKSPACE" "$RESULT_DIR" "latest" "$REFERENCE_HOST" "do-not-compare-error-message" "$DUMP_RESPONSE"
