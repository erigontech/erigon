...
DISABLED_TEST_LIST=(
  ...
  # Flaky: non-deterministic map iteration in StateOverrides.MovePrecompileToAddress causes
  # the reported non-precompile address to vary across runs; disabled until root cause is fixed
