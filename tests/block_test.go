...
func TestBlockchain(t *testing.T) {
	...
	bt.fails(`(?m)^TTestBlockchain/ValidBlocks/VMTests/vmSha3Test/sha3_memSizeQuadraticCost32.json`, "Needs to be fixed for TG")
	bt.fails(`(?m)^TTestBlockchain/ValidBlocks/VMTests/vmSha3Test/sha3_memSizeNoQuadraticCost31.json`, "Needs to be fixed for TG")
	bt.fails(`(?m)^TTestBlockchain/ValidBlocks/VMTests/vmSha3Test/sha3_memSizeQuadraticCost64_2.json`, "Needs to be fixed for TG")
	bt.fails(`(?m)^TTestBlockchain/ValidBlocks/VMTests/vmSha3Test/sha3_memSizeQuadraticCost63.json`, "Needs to be fixed for TG")
	bt.fails(`(?m)^TTestBlockchain/ValidBlocks/VMTests/vmSha3Test/sha3_memSizeQuadraticCost64.json`, "Needs to be fixed for TG")
	bt.fails(`(?m)^TTestBlockchain/ValidBlocks/VMTests/vmSha3Test/sha3_memSizeQuadraticCost33.json`, "Needs to be fixed for TG")
	bt.fails(`(?m)^TTestBlockchain/ValidBlocks/VMTests/vmSha3Test/sha3_memSizeQuadraticCost32_zeroSize.json`, "Needs to be fixed for TG")
