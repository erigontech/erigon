...
TestState/stTransactionTest/SuicidesMixingCoinbase.json
TestState/stSystemOperationsTest/suicideCoinbase.json

TestBlockchain/bcValidBlockTest/RecallSuicidedContractInOneBlock.json
TestBlockchain/bcValidBlockTest/gasPrice0.json/gasPrice0_Byzantium
TestBlockchain/bcStateTests/suicideCoinbase.json/suicideCoinbase_Byzantium
TestBlockchain/bcStateTests/suicideThenCheckBalance.json/suicideThenCheckBalance_Constantinople
*/
...
func TestStateDebug0(t *testing.T) {
	st := new(testMatcher)
	st.whitelist(`^TestStateDebug/stSStoreTest/InitCollision.json`)
	st.walk(t, stateTestDir, func(t *testing.T, name string, test *StateTest) {
		for _, subtest := range test.Subtests() {
