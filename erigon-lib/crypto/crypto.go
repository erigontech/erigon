...
func CreateEOFAddress(b common.Address, salt [32]byte, initcode []byte) common.Address {
	return common.BytesToAddress(Keccak256([]byte{0xff}, b.Bytes(), salt[:], Keccak256(initcode))[12:])
}
