...
type AssembleBlockRequest struct {
	...
	InclusionList         [][]byte                 `protobuf:"bytes,7,rep,name=inclusion_list,json=inclusionList,proto3" json:"inclusion_list,omitempty"`                                   // list of transactions that should be included in a payload
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *AssembleBlockRequest) GetInclusionList() [][]byte {
	if x != nil {
...
const file_execution_execution_proto_rawDesc = "" +
	...
	"\x06number\x18\x02 \x01(\x04R\x06number\"\x99\x03\n" +
	...
	"\x0einclusion_list\x18\a \x03(\fR\rinclusionListB\x1b\n" +
