...
var file_p2psentry_sentry_proto_depIdxs = []int32{
	...
	2,  // 16: sentry.HandShakeReply.side_protocols:type_name -> sentry.Protocol
	0,  // 17: sentry.MessagesRequest.ids:type_name -> sentry.MessageId
	31, // 18: sentry.PeersReply.peers:type_name -> types.PeerInfo
	2,  // 19: sentry.PeerCountPerProtocol.protocol:type_name -> sentry.Protocol
	21, // 20: sentry.PeerCountReply.counts_per_protocol:type_name -> sentry.PeerCountPerProtocol
	29, // 21: sentry.PeerByIdRequest.peer_id:type_name -> types.H512
	31, // 22: sentry.PeerByIdReply.peer:type_name -> types.PeerInfo
	29, // 23: sentry.PeerEvent.peer_id:type_name -> types.H512
	...
	32, // 28: sentry.Sentry.HandShake:input_type -> google.protobuf.Empty
	...
	18, // 33: sentry.Sentry.Messages:input_type -> sentry.MessagesRequest
	32, // 34: sentry.Sentry.Peers:input_type -> google.protobuf.Empty
	20, // 35: sentry.Sentry.PeerCount:input_type -> sentry.PeerCountRequest
	23, // 36: sentry.Sentry.PeerById:input_type -> sentry.PeerByIdRequest
	25, // 37: sentry.Sentry.PeerEvents:input_type -> sentry.PeerEventsRequest
	11, // 38: sentry.Sentry.AddPeer:input_type -> sentry.AddPeerRequest
	12, // 39: sentry.Sentry.RemovePeer:input_type -> sentry.RemovePeerRequest
	32, // 40: sentry.Sentry.NodeInfo:input_type -> google.protobuf.Empty
	16, // 41: sentry.Sentry.SetStatus:output_type -> sentry.SetStatusReply
	32, // 42: sentry.Sentry.PenalizePeer:output_type -> google.protobuf.Empty
	32, // 43: sentry.Sentry.PeerMinBlock:output_type -> google.protobuf.Empty
	17, // 44: sentry.Sentry.HandShake:output_type -> sentry.HandShakeReply
	...
	13, // 49: sentry.Sentry.Messages:output_type -> sentry.InboundMessage
	19, // 50: sentry.Sentry.Peers:output_type -> sentry.PeersReply
	22, // 51: sentry.Sentry.PeerCount:output_type -> sentry.PeerCountReply
	24, // 52: sentry.Sentry.PeerById:output_type -> sentry.PeerByIdReply
	26, // 53: sentry.Sentry.PeerEvents:output_type -> sentry.PeerEvent
	27, // 54: sentry.Sentry.AddPeer:output_type -> sentry.AddPeerReply
	28, // 55: sentry.Sentry.RemovePeer:output_type -> sentry.RemovePeerReply
	33, // 56: sentry.Sentry.NodeInfo:output_type -> types.NodeInfoReply
