...
const file_remote_ethbackend_proto_rawDesc = "" +
	...
	"\aAddPeer\x12\x16.remote.AddPeerRequest\x1a\x14.remote.AddPeerReply\x12A\n" +
...
var file_remote_ethbackend_proto_msgTypes = make([]protoimpl.MessageInfo, 39)
var file_remote_ethbackend_proto_goTypes = []any{
	...
	(*BlockForTxNumRequest)(nil),                     // 36: remote.BlockForTxNumRequest
	(*BlockForTxNumResponse)(nil),                    // 37: remote.BlockForTxNumResponse
	(*EarliestBlockAvailableReply)(nil),              // 38: remote.EarliestBlockAvailableReply
	(*SyncingReply_StageProgress)(nil),               // 39: remote.SyncingReply.StageProgress
	(*typesproto.H160)(nil),                          // 40: types.H160
	(*typesproto.H256)(nil),                          // 41: types.H256
	(*typesproto.NodeInfoReply)(nil),                 // 42: types.NodeInfoReply
	(*typesproto.PeerInfo)(nil),                      // 43: types.PeerInfo
	(*typesproto.AccountAbstractionTransaction)(nil), // 44: types.AccountAbstractionTransaction
	(*emptypb.Empty)(nil),                            // 45: google.protobuf.Empty
	(*BorTxnLookupRequest)(nil),                      // 46: remote.BorTxnLookupRequest
	(*BorEventsRequest)(nil),                         // 47: remote.BorEventsRequest
	(*typesproto.VersionReply)(nil),                  // 48: types.VersionReply
	(*BorTxnLookupReply)(nil),                        // 49: remote.BorTxnLookupReply
	(*BorEventsReply)(nil),                           // 50: remote.BorEventsReply
}
var file_remote_ethbackend_proto_depIdxs = []int32{
	40, // 0: remote.EtherbaseReply.address:type_name -> types.H160
	39, // 1: remote.SyncingReply.stages:type_name -> remote.SyncingReply.StageProgress
	41, // 2: remote.CanonicalHashReply.hash:type_name -> types.H256
	41, // 3: remote.HeaderNumberRequest.hash:type_name -> types.H256
	0,  // 4: remote.SubscribeRequest.type:type_name -> remote.Event
	0,  // 5: remote.SubscribeReply.type:type_name -> remote.Event
	40, // 6: remote.LogsFilterRequest.addresses:type_name -> types.H160
	41, // 7: remote.LogsFilterRequest.topics:type_name -> types.H256
	40, // 8: remote.SubscribeLogsReply.address:type_name -> types.H160
	41, // 9: remote.SubscribeLogsReply.block_hash:type_name -> types.H256
	41, // 10: remote.SubscribeLogsReply.topics:type_name -> types.H256
	41, // 11: remote.SubscribeLogsReply.transaction_hash:type_name -> types.H256
	41, // 12: remote.BlockRequest.block_hash:type_name -> types.H256
	41, // 13: remote.TxnLookupRequest.txn_hash:type_name -> types.H256
	42, // 14: remote.NodesInfoReply.nodes_info:type_name -> types.NodeInfoReply
	43, // 15: remote.PeersReply.peers:type_name -> types.PeerInfo
	41, // 16: remote.EngineGetPayloadBodiesByHashV1Request.hashes:type_name -> types.H256
	44, // 17: remote.AAValidationRequest.tx:type_name -> types.AccountAbstractionTransaction
	...
	45, // 21: remote.ETHBACKEND.Version:input_type -> google.protobuf.Empty
	45, // 22: remote.ETHBACKEND.Syncing:input_type -> google.protobuf.Empty
	...
	45, // 33: remote.ETHBACKEND.Peers:input_type -> google.protobuf.Empty
	27, // 34: remote.ETHBACKEND.AddPeer:input_type -> remote.AddPeerRequest
	45, // 35: remote.ETHBACKEND.PendingBlock:input_type -> google.protobuf.Empty
	46, // 36: remote.ETHBACKEND.BorTxnLookup:input_type -> remote.BorTxnLookupRequest
	47, // 37: remote.ETHBACKEND.BorEvents:input_type -> remote.BorEventsRequest
	34, // 38: remote.ETHBACKEND.AAValidation:input_type -> remote.AAValidationRequest
	36, // 39: remote.ETHBACKEND.BlockForTxNum:input_type -> remote.BlockForTxNumRequest
	45, // 40: remote.ETHBACKEND.MinimumBlockAvailable:input_type -> google.protobuf.Empty
	...
	48, // 44: remote.ETHBACKEND.Version:output_type -> types.VersionReply
	...
	28, // 55: remote.ETHBACKEND.NodeInfo:output_type -> remote.NodesInfoReply
	29, // 56: remote.ETHBACKEND.Peers:output_type -> remote.PeersReply
	30, // 57: remote.ETHBACKEND.AddPeer:output_type -> remote.AddPeerReply
	31, // 58: remote.ETHBACKEND.PendingBlock:output_type -> remote.PendingBlockReply
	49, // 59: remote.ETHBACKEND.BorTxnLookup:output_type -> remote.BorTxnLookupReply
	50, // 60: remote.ETHBACKEND.BorEvents:output_type -> remote.BorEventsReply
	35, // 61: remote.ETHBACKEND.AAValidation:output_type -> remote.AAValidationReply
	37, // 62: remote.ETHBACKEND.BlockForTxNum:output_type -> remote.BlockForTxNumResponse
	38, // 63: remote.ETHBACKEND.MinimumBlockAvailable:output_type -> remote.EarliestBlockAvailableReply
