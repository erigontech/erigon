...
// Source: github.com/ledgerwatch/erigon-lib/gointerfaces/sentry (interfaces: SentryClient)
//
// Generated by this command:
//
//	mockgen -typed=true -destination=./sentry_client_mock.go -package=sentry . SentryClient
//
