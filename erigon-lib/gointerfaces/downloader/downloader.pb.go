...
type ProhibitRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	WhitelistAdd    []string `protobuf:"bytes,1,rep,name=whitelistAdd,proto3" json:"whitelistAdd,omitempty"`       // nil - means "don't modify". non-nil - means "merge with current whitelist".
	WhitelistRemove []string `protobuf:"bytes,2,rep,name=whitelistRemove,proto3" json:"whitelistRemove,omitempty"` // nil - means "don't modify"
}

func (x *ProhibitRequest) Reset() {
	*x = ProhibitRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProhibitRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProhibitRequest) ProtoMessage() {}

func (x *ProhibitRequest) ProtoReflect() protoreflect.Message {
	mi := &file_downloader_downloader_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProhibitRequest.ProtoReflect.Descriptor instead.
func (*ProhibitRequest) Descriptor() ([]byte, []int) {
	return file_downloader_downloader_proto_rawDescGZIP(), []int{5}
}

func (x *ProhibitRequest) GetWhitelistAdd() []string {
	if x != nil {
		return x.WhitelistAdd
	}
	return nil
}

func (x *ProhibitRequest) GetWhitelistRemove() []string {
	if x != nil {
		return x.WhitelistRemove
	}
	return nil
}

type ProhibitReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Whitelist []string `protobuf:"bytes,1,rep,name=whitelist,proto3" json:"whitelist,omitempty"` // current whitelist
}

func (x *ProhibitReply) Reset() {
	*x = ProhibitReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProhibitReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProhibitReply) ProtoMessage() {}

func (x *ProhibitReply) ProtoReflect() protoreflect.Message {
	mi := &file_downloader_downloader_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProhibitReply.ProtoReflect.Descriptor instead.
func (*ProhibitReply) Descriptor() ([]byte, []int) {
	return file_downloader_downloader_proto_rawDescGZIP(), []int{6}
}

func (x *ProhibitReply) GetWhitelist() []string {
	if x != nil {
		return x.Whitelist
	}
	return nil
...
var file_downloader_downloader_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_downloader_downloader_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_downloader_downloader_proto_goTypes = []interface{}{
	...
	(*ProhibitRequest)(nil), // 5: downloader.ProhibitRequest
	(*ProhibitReply)(nil),   // 6: downloader.ProhibitReply
	(*StatsReply)(nil),      // 7: downloader.StatsReply
	(*types.H160)(nil),      // 8: types.H160
	(*emptypb.Empty)(nil),   // 9: google.protobuf.Empty
}
var file_downloader_downloader_proto_depIdxs = []int32{
	8, // 0: downloader.AddItem.torrent_hash:type_name -> types.H160
	0, // 1: downloader.AddRequest.items:type_name -> downloader.AddItem
	5, // 2: downloader.Downloader.Prohibit:input_type -> downloader.ProhibitRequest
	...
	6, // 7: downloader.Downloader.Prohibit:output_type -> downloader.ProhibitReply
	9, // 8: downloader.Downloader.Add:output_type -> google.protobuf.Empty
	9, // 9: downloader.Downloader.Delete:output_type -> google.protobuf.Empty
	9, // 10: downloader.Downloader.Verify:output_type -> google.protobuf.Empty
	7, // 11: downloader.Downloader.Stats:output_type -> downloader.StatsReply
