...
// Source: github.com/ledgerwatch/erigon-lib/gointerfaces/downloader (interfaces: DownloaderClient)
//
// Generated by this command:
//
//	mockgen -typed=true -destination=./downloader_client_mock.go -package=downloader . DownloaderClient
//
