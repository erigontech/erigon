...
type EnrEntry struct {
	...
	Remove bool   `protobuf:"varint,2,opt,name=remove,proto3" json:"remove,omitempty"` // if set, remove this entry instead of updating. data is ignored if remove is true
...
var file_p2psentinel_sentinel_proto_rawDesc = []byte{
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xcd, 0x04, 0x0a, 0x08, 0x53, 0x65, 0x6e, 0x74, 0x69, 0x6e,
	0x65, 0x6c, 0x12, 0x45, 0x0a, 0x0f, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x47,
	...
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x37, 0x0a, 0x09,
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x45, 0x6e, 0x72, 0x12, 0x12, 0x2e, 0x73, 0x65, 0x6e, 0x74,
	0x69, 0x6e, 0x65, 0x6c, 0x2e, 0x45, 0x6e, 0x72, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x1a, 0x16, 0x2e,
...
var file_p2psentinel_sentinel_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
...
var file_p2psentinel_sentinel_proto_depIdxs = []int32{
	...
	9,  // 1: sentinel.Status.finalized_root:type_name -> types.H256
	9,  // 2: sentinel.Status.head_root:type_name -> types.H256
	...
	0,  // 16: sentinel.Sentinel.SetStatus:output_type -> sentinel.EmptyMessage
	5,  // 17: sentinel.Sentinel.GetPeers:output_type -> sentinel.PeerCount
	0,  // 18: sentinel.Sentinel.BanPeer:output_type -> sentinel.EmptyMessage
	0,  // 19: sentinel.Sentinel.UnbanPeer:output_type -> sentinel.EmptyMessage
	0,  // 20: sentinel.Sentinel.PenalizePeer:output_type -> sentinel.EmptyMessage
	0,  // 21: sentinel.Sentinel.RewardPeer:output_type -> sentinel.EmptyMessage
	0,  // 22: sentinel.Sentinel.PublishGossip:output_type -> sentinel.EmptyMessage
	0,  // 23: sentinel.Sentinel.UpdateEnr:output_type -> sentinel.EmptyMessage
