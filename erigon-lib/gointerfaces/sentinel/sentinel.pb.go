...
func (x *SubscriptionData) GetTopics() []string {
	if x != nil {
		return x.Topics
	}
	return nil
...
type EnrEntry struct {
	...
	Key    string `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`        // the key of the data
	Remove bool   `protobuf:"varint,2,opt,name=remove,proto3" json:"remove,omitempty"` // if set, remove this entry instead of updating.
	Data   []byte `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`      // rlp compatible enr data
}

func (x *EnrEntry) Reset() {
	*x = EnrEntry{}
	if protoimpl.UnsafeEnabled {
...
func (x *EnrEntry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EnrEntry) ProtoMessage() {}

func (x *EnrEntry) ProtoReflect() protoreflect.Message {
	mi := &file_p2psentinel_sentinel_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EnrEntry.ProtoReflect.Descriptor instead.
func (*EnrEntry) Descriptor() ([]byte, []int) {
	return file_p2psentinel_sentinel_proto_rawDescGZIP(), []int{8}
}

func (x *EnrEntry) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *EnrEntry) GetRemove() bool {
	if x != nil {
		return x.Remove
	}
	return false
...
type NodeData struct {
	...
	NodeId []byte `protobuf:"bytes,1,opt,name=NodeId,proto3" json:"NodeId,omitempty"` // 32 byte node id
}
...
func (x *NodeData) GetNodeId() []byte {
	if x != nil {
		return x.NodeId
	}
	return nil
...
var file_p2psentinel_sentinel_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x52, 0x0a, 0x10, 0x53, 0x75, 0x62,
	...
	0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x88, 0x01, 0x01, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x6f,
	0x70, 0x69, 0x63, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x74, 0x6f, 0x70, 0x69,
	0x63, 0x73, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x22, 0x18, 0x0a,
	0x04, 0x50, 0x65, 0x65, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x70, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x70, 0x69, 0x64, 0x22, 0x66, 0x0a, 0x0a, 0x47, 0x6f, 0x73, 0x73, 0x69,
	...
	0x6e, 0x74, 0x69, 0x6e, 0x65, 0x6c, 0x2e, 0x50, 0x65, 0x65, 0x72, 0x48, 0x00, 0x52, 0x04, 0x70,
	0x65, 0x65, 0x72, 0x88, 0x01, 0x01, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x70, 0x65, 0x65, 0x72, 0x22,
	0xcd, 0x01, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x66, 0x6f,
	0x72, 0x6b, 0x5f, 0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x0a, 0x66, 0x6f, 0x72, 0x6b, 0x44, 0x69, 0x67, 0x65, 0x73, 0x74, 0x12, 0x32, 0x0a, 0x0e, 0x66,
	...
	,
	...
	0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x22, 0x0a, 0x04, 0x70, 0x65, 0x65, 0x72, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x73, 0x65, 0x6e, 0x74, 0x69, 0x6e, 0x65, 0x6c,
	0x2e, 0x50, 0x65, 0x65, 0x72, 0x52, 0x04, 0x70, 0x65, 0x65, 0x72, 0x22, 0x48, 0x0a, 0x08, 0x45,
	0x6e, 0x72, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x6d,
	...
	,
	...
	0x61, 0x67, 0x65, 0x12, 0x36, 0x0a, 0x0c, 0x50, 0x65, 0x6e, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x50,
	...
	,
}
...
var file_p2psentinel_sentinel_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_p2psentinel_sentinel_proto_goTypes = []interface{}{
	...
	(*EnrEntry)(nil),         // 8: sentinel.EnrEntry
	(*NodeData)(nil),         // 9: sentinel.NodeData
...
var file_p2psentinel_sentinel_proto_depIdxs = []int32{
	...
	10, // 1: sentinel.Status.finalized_root:type_name -> types.H256
	10, // 2: sentinel.Status.head_root:type_name -> types.H256
	...
	8,  // 13: sentinel.Sentinel.UpdateEnr:input_type -> sentinel.EnrEntry
	0,  // 14: sentinel.Sentinel.GetNodeInfo:input_type -> sentinel.EmptyMessage
	3,  // 15: sentinel.Sentinel.SubscribeGossip:output_type -> sentinel.GossipData
	7,  // 16: sentinel.Sentinel.SendRequest:output_type -> sentinel.ResponseData
	0,  // 17: sentinel.Sentinel.SetStatus:output_type -> sentinel.EmptyMessage
	5,  // 18: sentinel.Sentinel.GetPeers:output_type -> sentinel.PeerCount
	0,  // 19: sentinel.Sentinel.BanPeer:output_type -> sentinel.EmptyMessage
	0,  // 20: sentinel.Sentinel.UnbanPeer:output_type -> sentinel.EmptyMessage
	0,  // 21: sentinel.Sentinel.PenalizePeer:output_type -> sentinel.EmptyMessage
	0,  // 22: sentinel.Sentinel.RewardPeer:output_type -> sentinel.EmptyMessage
	0,  // 23: sentinel.Sentinel.PublishGossip:output_type -> sentinel.EmptyMessage
	0,  // 24: sentinel.Sentinel.UpdateEnr:output_type -> sentinel.EmptyMessage
	9,  // 25: sentinel.Sentinel.GetNodeInfo:output_type -> sentinel.NodeData
