...
func TestE2SnapSchema(t *testing.T) {
	...
	require.Equal(t, snaptype.V1_0, info.Version)
...
func TestE3SnapSchemaForDomain1(t *testing.T) {
	...
	accFull := p.BtIdxFile(snaptype.V1_0, stepFrom, stepTo)
	_, fName = filepath.Split(accFull)
	require.Equal(t, "v1.0-accounts.288-296.bt", fName)

	require.Panics(t, func() {
		p.AccessorIdxFile(snaptype.V1_0, stepFrom, stepTo, 0)
	})

	exFull := p.ExistenceFile(snaptype.V1_0, stepFrom, stepTo)
...
func TestE3SnapSchemaForCommitmentDomain(t *testing.T) {
	...
	accFull := p.AccessorIdxFile(snaptype.V1_0, stepFrom, stepTo, 0)
	_, fName = filepath.Split(accFull)
...
func TestE3SnapSchemaForII(t *testing.T) {
	...
	fileName := p.DataFile(snaptype.V1_0, stepFrom, stepTo)
