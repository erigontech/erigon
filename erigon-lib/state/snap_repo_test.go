...
func populateFiles(t *testing.T, dirs datadir.Dirs, name string, extensions []string, dataFolder string, allFiles *dhiiFiles) (dataFileCount, btCount, existenceCount, accessorCount int) {
	...
	touch(t, domainFolder, allFiles.domainFiles, fileGen)
	touch(t, historyFolder, allFiles.historyFiles, fileGen)
	touch(t, accessorFolder, allFiles.accessorFiles, fileGen)
	touch(t, idxFolder, allFiles.idxFiles, fileGen)
