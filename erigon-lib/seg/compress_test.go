...
func TestCompressDict1(t *testing.T) {
	...
	for g.HasNext() {
		// next word is `nil`
		require.NotEqual(t, 0, g.MatchPrefixCmp([]byte("long")))
		...
		require.NotEqual(t, 0, g.MatchPrefixCmp([]byte("longlong")))
		require.NotEqual(t, 0, g.MatchPrefixCmp([]byte("wordnotmatch")))
		require.NotEqual(t, 0, g.MatchPrefixCmp([]byte("longnotmatch")))
		require.Equal(t, 0, g.MatchPrefixCmp([]byte{}))
