	...
	tests := []struct {
		...
		// Gnosis test cases
		{
			...
			[]testcase{
				...
				{19040000, 1636753580, ID{Hash: checksumToBytes(0x018479d3), Next: 0}},        // First London block
				{21735000, 1650443255, ID{Hash: checksumToBytes(0x018479d3), Next: 0}},        // First GIP-31 block
			},
		},
		// Chiado test cases
		{
