...
func (hr *HistoryReaderV3) ReadAccountData(address common.Address) (*accounts.Account, error) {
	...
	var err error
	if hr.ttx != nil {
		enc, ok, err = hr.ttx.HistoryGet(temporal.AccountsHistory, address.Bytes(), hr.txNum)
	} else {
...
func (hr *HistoryReaderV3) ReadAccountStorage(address common.Address, incarnation uint64, key *common.Hash) ([]byte, error) {
	...
	var err error
	if hr.ttx != nil {
		enc, ok, err = hr.ttx.HistoryGet(temporal.StorageHistory, append(address.Bytes(), key.Bytes()...), hr.txNum)
	} else {
...
func (hr *HistoryReaderV3) ReadAccountCode(address common.Address, incarnation uint64, codeHash common.Hash) ([]byte, error) {
	...
	var err error
	if hr.ttx != nil {
		enc, ok, err = hr.ttx.HistoryGet(temporal.CodeHistory, address.Bytes(), hr.txNum)
	} else {
