...
func opSload(pc *uint64, interpreter *EVMInterpreter, callContext *callCtx) ([]byte, error) {
	...
	val := interpreter.evm.IntraBlockState.GetState(callContext.contract.Address(), common.BigToHash(loc))
...
func opSuicide(pc *uint64, interpreter *EVMInterpreter, callContext *callCtx) ([]byte, error) {
	...
	interpreter.evm.IntraBlockState.AddBalance(common.BigToAddress(callContext.stack.pop()), balance)
