...
func (evm *EVM) Create(caller ContractRef, code []byte, gas uint64, value *uint256.Int, salt []byte) (ret []byte, contractAddr common.Address, leftOverGas uint64, err error) {
