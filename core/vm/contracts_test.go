...
var allPrecompiles = map[libcommon.Address]PrecompiledContract{
	...
	libcommon.BytesToAddress([]byte{0x0f, 0x0a}): &bls12381G1Add{},
	libcommon.BytesToAddress([]byte{0x0f, 0x0b}): &bls12381G1MultiExp{},
	libcommon.BytesToAddress([]byte{0x0f, 0x0c}): &bls12381G2Add{},
	libcommon.BytesToAddress([]byte{0x0f, 0x0d}): &bls12381G2MultiExp{},
	libcommon.BytesToAddress([]byte{0x0f, 0x0e}): &bls12381Pairing{},
	libcommon.BytesToAddress([]byte{0x0f, 0x0f}): &bls12381MapFpToG1{},
	libcommon.BytesToAddress([]byte{0x0f, 0x10}): &bls12381MapFp2ToG2{},
}
