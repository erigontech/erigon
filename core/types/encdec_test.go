...
func compareTransactions(t *testing.T, a, b Transaction) {
	...
	check(t, "TxnSlot.Type", a.Type(), b.Type())
	check(t, "TxnSlot.GetChainID", a.GetChainID(), b.GetChainID())
	check(t, "TxnSlot.GetNonce", a.GetNonce(), b.GetNonce())
	check(t, "TxnSlot.GetPrice", a.GetPrice(), b.GetPrice())
	check(t, "TxnSlot.GetTip", a.GetTip(), b.GetTip())
	check(t, "TxnSlot.GetFeeCap", a.GetFeeCap(), b.GetFeeCap())
	check(t, "TxnSlot.GetBlobHashes", a.GetBlobHashes(), b.GetBlobHashes())
	check(t, "TxnSlot.GetGas", a.GetGas(), b.GetGas())
	check(t, "TxnSlot.GetBlobGas", a.GetBlobGas(), b.GetBlobGas())
	check(t, "TxnSlot.GetValue", a.GetValue(), b.GetValue())
	check(t, "TxnSlot.GetTo", a.GetTo(), b.GetTo())
	check(t, "TxnSlot.GetData", a.GetData(), b.GetData())
	check(t, "TxnSlot.GetAccessList", a.GetAccessList(), b.GetAccessList())
	check(t, "TxnSlot.V", v1, v2)
	check(t, "TxnSlot.R", r1, r2)
	check(t, "TxnSlot.S", s1, s2)
}
