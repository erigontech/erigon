...
// Source: github.com/erigontech/erigon/zk/txpool (interfaces: Pool)
//
...
func (mr *MockPoolMockRecorder) OnNewBlock(ctx, stateChanges, unwindTxs, minedTxs, tx any) *MockPoolOnNewBlockCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OnNewBlock", reflect.TypeOf((*MockPool)(nil).OnNewBlock), ctx, stateChanges, unwindTxs, minedTxs, tx)
