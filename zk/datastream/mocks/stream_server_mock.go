...
// Source: github.com/erigontech/erigon/zk/datastream/server (interfaces: StreamServer)
//
...
func (m *MockStreamServer) AddStreamBookmark(bookmark []byte) (uint64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddStreamBookmark", bookmark)
	ret0, _ := ret[0].(uint64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStreamServerMockRecorder) AddStreamBookmark(bookmark any) *MockStreamServerAddStreamBookmarkCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddStreamBookmark", reflect.TypeOf((*MockStreamServer)(nil).AddStreamBookmark), bookmark)
...
func (m *MockStreamServer) AddStreamEntry(etype datastreamer.EntryType, data []byte) (uint64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddStreamEntry", etype, data)
	ret0, _ := ret[0].(uint64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStreamServerMockRecorder) AddStreamEntry(etype, data any) *MockStreamServerAddStreamEntryCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddStreamEntry", reflect.TypeOf((*MockStreamServer)(nil).AddStreamEntry), etype, data)
...
func (m *MockStreamServer) GetBookmark(bookmark []byte) (uint64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBookmark", bookmark)
	ret0, _ := ret[0].(uint64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStreamServerMockRecorder) GetBookmark(bookmark any) *MockStreamServerGetBookmarkCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBookmark", reflect.TypeOf((*MockStreamServer)(nil).GetBookmark), bookmark)
...
func (m *MockStreamServer) GetDataBetweenBookmarks(bookmarkFrom, bookmarkTo []byte) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDataBetweenBookmarks", bookmarkFrom, bookmarkTo)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStreamServerMockRecorder) GetDataBetweenBookmarks(bookmarkFrom, bookmarkTo any) *MockStreamServerGetDataBetweenBookmarksCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDataBetweenBookmarks", reflect.TypeOf((*MockStreamServer)(nil).GetDataBetweenBookmarks), bookmarkFrom, bookmarkTo)
...
func (m *MockStreamServer) GetEntry(entryNum uint64) (datastreamer.FileEntry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEntry", entryNum)
...
func (mr *MockStreamServerMockRecorder) GetEntry(entryNum any) *MockStreamServerGetEntryCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEntry", reflect.TypeOf((*MockStreamServer)(nil).GetEntry), entryNum)
...
func (m *MockStreamServer) GetFirstEventAfterBookmark(bookmark []byte) (datastreamer.FileEntry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetFirstEventAfterBookmark", bookmark)
	ret0, _ := ret[0].(datastreamer.FileEntry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStreamServerMockRecorder) GetFirstEventAfterBookmark(bookmark any) *MockStreamServerGetFirstEventAfterBookmarkCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFirstEventAfterBookmark", reflect.TypeOf((*MockStreamServer)(nil).GetFirstEventAfterBookmark), bookmark)
...
func (m *MockStreamServer) TruncateFile(entryNum uint64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TruncateFile", entryNum)
	ret0, _ := ret[0].(error)
	return ret0
}

// TruncateFile indicates an expected call of TruncateFile.
func (mr *MockStreamServerMockRecorder) TruncateFile(entryNum any) *MockStreamServerTruncateFileCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TruncateFile", reflect.TypeOf((*MockStreamServer)(nil).TruncateFile), entryNum)
...
func (m *MockStreamServer) UpdateEntryData(entryNum uint64, etype datastreamer.EntryType, data []byte) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateEntryData", entryNum, etype, data)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateEntryData indicates an expected call of UpdateEntryData.
func (mr *MockStreamServerMockRecorder) UpdateEntryData(entryNum, etype, data any) *MockStreamServerUpdateEntryDataCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateEntryData", reflect.TypeOf((*MockStreamServer)(nil).UpdateEntryData), entryNum, etype, data)
