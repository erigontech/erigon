...
var file_datastream_proto_rawDesc = []byte{
	...
	0x2a, 0xad, 0x01, 0x0a, 0x09, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1a,
	...
	,
	...
	0x6f, 0x64, 0x65, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x73, 0x74,
...
func file_datastream_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_datastream_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_datastream_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_datastream_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_datastream_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_datastream_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_datastream_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_datastream_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_datastream_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*Debug); i {
			case 0:
				return &v.state
			case 1:
