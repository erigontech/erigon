...
func main() {
	...
	client1 := client.NewClient(ctx, stream1, false, 0, 0, client.DefaultEntryChannelSize)
	client2 := client.NewClient(ctx, stream2, false, 0, 0, client.DefaultEntryChannelSize)
