...
func prepareBatchCounters(batchContext *BatchContext, batchState *BatchState, unlimitedCounters bool) *vm.BatchCounterCollector {
	return vm.NewBatchCounterCollector(batchContext.sdb.smt.GetDepth(), uint16(batchState.forkId), batchContext.cfg.zk.VirtualCountersSmtReduction, unlimitedCounters, nil)
}
