...
func TestUseBridgeReader(t *testing.T) {
	...
	bor := New(polychain.Amoy.Config, nil, nil, nil, nil, nil, nil, br, nil)
...
func TestUseSpanReader(t *testing.T) {
	...
	b := New(polychain.Amoy.Config, nil, nil, nil, nil, nil, nil, nil, sr)
...
func TestCommitStatesIndore(t *testing.T) {
	...
	bor := New(polychain.BorDevnet.Config, nil, nil, nil, nil, nil, nil, br, nil)
