...
func (m *MockheimdallWaypointsFetcher) Synchronize(ctx context.Context) error {
	m.ctrl.T.Helper()
...
func (mr *MockheimdallWaypointsFetcherMockRecorder) Synchronize(ctx any) *MockheimdallWaypointsFetcherSynchronizeCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Synchronize", reflect.TypeOf((*MockheimdallWaypointsFetcher)(nil).Synchronize), ctx)
	return &MockheimdallWaypointsFetcherSynchronizeCall{Call: call}
}

// MockheimdallWaypointsFetcherSynchronizeCall wrap *gomock.Call
type MockheimdallWaypointsFetcherSynchronizeCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockheimdallWaypointsFetcherSynchronizeCall) Return(arg0 error) *MockheimdallWaypointsFetcherSynchronizeCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockheimdallWaypointsFetcherSynchronizeCall) Do(f func(context.Context) error) *MockheimdallWaypointsFetcherSynchronizeCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockheimdallWaypointsFetcherSynchronizeCall) DoAndReturn(f func(context.Context) error) *MockheimdallWaypointsFetcherSynchronizeCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
